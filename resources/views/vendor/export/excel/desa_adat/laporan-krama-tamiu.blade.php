<table>
    <thead>
        <tr>
            @if (count($data['request']->banjar_adat_tamiu) > 0)
    ...
    <tbody>
        ...
        <tr>            
            ...
            <th style="text-align:center; border: 0.1px solid black;">NOMOR<br>KRAMA TAMIU</th>
        ...
        @foreach ($data['krama_tamiu'] as $krama_tamiu)
            <tr>
                ...
                <td style="border: 0.1px solid black;">{{ $krama_tamiu->nomor_krama_tamiu }}</td>
                ...
                <td style="border: 0.1px solid black;">{{ $krama_tamiu->nama_banjar_adat ?? '-' }}</td>
