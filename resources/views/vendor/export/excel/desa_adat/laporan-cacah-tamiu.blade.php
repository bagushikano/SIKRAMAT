<table>
    ...
    <tbody>
        ...
        <tr>            
            ...
            <th style="text-align:center; border: 0.1px solid black;">NOMOR<br>CACAH TAMIU</th>
        ...
        @foreach ($data['tamiu'] as $tamiu)
            <tr>
                ...
                <td style="border: 0.1px solid black;">{{ $tamiu->nomor_cacah_tamiu }}</td>
                ...
                <td style="border: 0.1px solid black;">{{ $tamiu->banjar_adat->nama_banjar_adat ?? 'hahahah' }}</td>
