    ...
    <table class="table mt-5 fs-8">
        <thead class="text-center">
            <tr>
                ...
                <th style="width: 130px">NAMA<br>PURUSA</th>
                <th style="width: 130px">NAMA<br>PRADANA</th>
                <th style="width: 75px">TANGGAL<br>PERCERAIAN</th>
                <th style="width: 70px">BANJAR<br>ADAT</th>
        ...
        <tbody>
            @foreach ($data['perceraian'] as $perceraian)
                <tr>
                    ...
                    <td>{{ $perceraian->banjar_adat_purusa->nama_banjar_adat ?? '-' }}</td>
