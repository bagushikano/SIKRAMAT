...
<body>
    ...
    <table class="table mt-5 fs-8">
        <thead class="text-center">
            <tr>
                <th>NO</th>
                <th style="width: 20px">NO. <br>PERKAWINAN</th>
                <th style="width: 50px">JENIS<br>PERKAWINAN</th>
                <th style="width: 100px">NAMA<br>PURUSA</th>
                <th style="width: 100px">NAMA<br>PRADANA</th>
                <th style="width: 60px">TANGGAL<br>PERKAWINAN</th>
                <th style="width: 60px">BANJAR<br>ADAT</th>
