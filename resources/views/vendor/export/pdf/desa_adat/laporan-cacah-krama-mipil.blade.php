...
<body>
    <p class="my-auto fw-bold text-center fs-10">LAPORAN DATA CACAH KRAMA MIPIL</p>
    ...
    <table class="table mt-5 fs-8">
        <thead class="text-center">
            <tr>
                <th>NO</th>
                <th>NOMOR CACAH<br>KRAMA MIPIL</th>
        ...
        <tbody>
            @foreach ($data['krama_mipil'] as $krama_mipil)
                <tr>
                    ...
                    <td>{{ $krama_mipil->nomor_cacah_krama_mipil }}</td>
                    ...
                    <td>{{ $krama_mipil->nama_banjar_adat ?? '-' }}</td>
