        ...
        <tbody>
            @foreach ($data['maperas'] as $maperas)
                <tr>
                    ...
                    @if($maperas->jenis == 'Beda Banjar Adat (Keluar)' || $maperas->jenis == 'Campuran Keluar')
                        <td class="align-middle">{{ $maperas->banjar_adat_lama->nama_banjar_adat ?? '-' }}</td>
                    @else 
                        <td class="align-middle">{{ $maperas->banjar_adat_baru->nama_banjar_adat ?? '-' }}</td>
                    @endif
