...
<body>
    <p class="my-auto fw-bold text-center fs-10">LAPORAN DATA CACAH TAMIU</p>
        ...
        <tbody>
            @foreach ($data['tamiu'] as $tamiu)
                <tr>
                    ...
                    <td>{{ $tamiu->banjar_adat->nama_banjar_adat ?? '-' }}</td>
