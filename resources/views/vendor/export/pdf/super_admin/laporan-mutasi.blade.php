...
<body>
    <p class="my-auto fw-bold text-center fs-10">LAPORAN DATA MUTASI KEPENDUDUKAN</p>
    ...
    <table class="table mt-5 fs-8">
        <thead class="text-center">
            <tr class="text-center">
                ...
                <th rowspan="2">PERKAWINAN</th>
                <th rowspan="2">PERCERAIAN</th>
                <th rowspan="2">MAPERAS</th>
            </tr>
            <tr class="text-center">
        ...
        <tbody>
            @foreach($data['desa_adat'] as $desa_adat)
                <tr class="align-middle text-center">
                    ...
                    <td>{{ $desa_adat->jumlah_kelahiran_laki }}</td>
                    <td>{{ $desa_adat->jumlah_kelahiran_perempuan }}</td>
                    <td>{{ $desa_adat->jumlah_kelahiran }}</td>
                    <td>{{ $desa_adat->jumlah_kematian_laki }}</td>
                    <td>{{ $desa_adat->jumlah_kematian_perempuan }}</td>
                    <td>{{ $desa_adat->jumlah_kematian }}</td>
                    <td>{{ $desa_adat->jumlah_perkawinan }}</td>
                    <td>{{ $desa_adat->jumlah_perceraian }}</td>
                    <td>{{ $desa_adat->jumlah_maperas }}</td>
                </tr>
            @endforeach
            <tr class="text-center">
