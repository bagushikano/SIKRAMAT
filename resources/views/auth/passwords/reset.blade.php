            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right">{{ __('Passwodsadrd') }}</label>
                            ...
                            <div class="card-body">
                                ...
                                <div class="p-3">
                                    <form method="POST" action="{{ route('password.update') }}">
                                      ...
                                      <button type="submit" class="btn btn-primary btn-rounded btn-lg btn-block mt-2">Reset Password</button>
                                    </form>
                                </div>
                            </div>
                        </div>
