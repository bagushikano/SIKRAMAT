                            ...
                            <div class="col-xl-5 col-lg-6 col-md-8 col-sm-11">
                                ...
                                <div class="card my-5">
                                    <div class="card-body p-5 text-center">
                                        <div class="h1 font-weight-light text-bold mb-1">Selamat Datang!</div>
                                        <!-- Social login links-->
                                    ...
                                    <div class="card-body p-5">
                                        ...
                                        <form method="POST" action="{{ route('login-post') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form-control-solid py-4" type="email" placeholder="Masukkan alamat email" aria-label="Email Address" name="email" aria-describedby="emailExample" />
                                            </div>
                                            <!-- Form Group (password)-->
                                            <div class="form-group">
                                                <label class="text-gray-600 small" for="passwordExample">Password</label>
                                                <input class="form-control form-control-solid py-4" type="password" placeholder="Masukkan password" aria-label="Password" name="password" aria-describedby="passwordExample" />
                                            </div>
                                            <!-- Form Group (forgot password link)-->
                                            <div class="form-group"><a class="small" href="auth-password-social.html">Lupa password?</a></div>
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mb-0">
                                                <div class="custom-control custom-control-solid custom-checkbox">
                                                    ...
                                                    <label class="custom-control-label" for="customCheck1">Simpan password</label>
                                                </div>
            ...
            <div id="layoutAuthentication_footer">
                <footer class="footer mt-auto footer-dark">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 small">Copyright &copy; Sistem Informasi Manajemen Kependudukan Desa Adat Terintegrasi {{ date('Y', strtotime(date('Y-m-d H:i:s'))) }}</div>
