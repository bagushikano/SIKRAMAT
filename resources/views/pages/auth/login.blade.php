                            ...
                            <div class="card-body">
                                ...
                                <div class="p-3">
                                    <form method="POST" action="{{ route('login-post') }}">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6 captcha">   
                                                <div class="form-group">
                                                    ...
                                                    <a href="javascript:void(0)" class="text-decoration-none link-primary small" id="reload">Refresh Captcha</a>
                                                </div>                                        
                                            </div>
                                            <div class="col-lg-6 captcha">
                                      ...
                                      <button type="submit" class="btn btn-primary btn-rounded btn-lg btn-block mt-2">Login</button>
                                    </form>
                                    <label class="forgot-psw d-flex justify-content-between mt-2"> 
                                        <a id="forgot-psw" href="/password/reset">Lupa password?</a>
                                        <a id="forgot-psw" href="{{ route('Register Awal') }}">Registrasi</a>
                                    </label>
                                </div>
                            </div>
                        </div>
