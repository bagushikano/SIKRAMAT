                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            ...
                            <div class="page-header-subtitle">
                                Data Diri <span class="font-weight-bold">@if($penduduk->gelar_depan != ''){{ $penduduk->gelar_depan }} @endif{{ $penduduk->nama }}@if($penduduk->gelar_belakang != ''), {{ $penduduk->gelar_belakang }}@endif</span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card mb-4 mt-4">
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                <div class="wizard-step-text-name text-dark">Data Diri</div>
                                <div class="wizard-step-text-details text-dark">Detail Data Diri Anggota Keluarga</div>
                            </div>
                        </a>
                    </div>
                </div>     
                <div class="card-body">
                        ...
                        <div class="col-lg-9 col-sm-12">
                            ...
                            @if($krama->status == '0')
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-12">
                                        <span class="text-dark font-weight-bold">: {{ date('d M Y', strtotime($krama->tanggal_nonaktif)) ?? '-' }}</span>
                                    </div>
                                </div>
                    ...
                    <div class="float-left mx-5">
                        <a class="btn btn-danger mr-2 btn-icon-split text-end" href="{{ route('Keluarga Krama') }}">
                            <span class="icon">
