                        ...
                        <div class="row justify-content-center">
                            <div class="col-xxl-10 col-xl-10">
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12 py-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error ('nik') is-invalid @enderror"  id="nik" name="nik" placeholder="Masukkan NIK" value="{{ old('nik', $kelahiran->cacah_krama_mipil->penduduk->nik) }}">
                                            @error('nik')
                                    ...
                                    <div class="col-lg-6 col-sm-12 py-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error ('nomor_akta_kelahiran') is-invalid @enderror"  id="nomor_akta_kelahiran" name="nomor_akta_kelahiran" placeholder="Masukkan Nomor Akta Kelahiran" value="{{ old('nomor_akta_kelahiran', $kelahiran->nomor_akta_kelahiran) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error ('nama') is-invalid @enderror" id="nama" name="nama" placeholder="Masukkan Nama" value="{{ old('nama', $kelahiran->cacah_krama_mipil->penduduk->nama) }}" required>
                                    @error('nama')
                                        <div class="invalid-feedback text-start">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12 py-2">
                                        ...
                                        <input type="text" class="form-control @error ('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir', $kelahiran->cacah_krama_mipil->penduduk->tempat_lahir) }}" placeholder="Masukkan Tempat Lahir" required>
                                        @error('tempat_lahir')
                                            <div class="invalid-feedback text-start">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-lg-6 col-sm-12 py-2">
                                        ...
                                        <input type="text" class="datepicker-here form-control @error ('tanggal_lahir') is-invalid @enderror" placeholder="Masukkan Tanggal Lahir" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir', date('d M Y', strtotime($kelahiran->tanggal_lahir)) ?? '-' ) }}" placeholder="Masukkan Tanggal Lahir" required>
                                        @error('tanggal_lahir')
                                            <div class="invalid-feedback text-start">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-sm-12 py-2">
                                        ...
                                        <select class="select2 custom-select @error ('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" id="jenis_kelamin"  style="width: 100%" required aria-placeholder="Pilih Jenis Kelamin" required>
                                            ...
                                            @else
                                                <option value="laki-laki" @if($kelahiran->cacah_krama_mipil->penduduk->jenis_kelamin == 'laki-laki') selected @endif>Laki-laki</option>
                                                <option value="perempuan" @if($kelahiran->cacah_krama_mipil->penduduk->jenis_kelamin == 'perempuan') selected @endif>Perempuan</option>
                                            @endif
                                        </select>
                                        @error('jenis_kelamin')
                                            <div class="invalid-feedback text-start">
                                    ...
                                    <div class="col-lg-6 col-sm-12 py-2">
                                        ...
                                        <select class="select2 custom-select @error ('golongan_darah') is-invalid @enderror" name="golongan_darah" id="golongan_darah"  style="width: 100%" required aria-placeholder="Pilih Golongan Darah" required>
                                            ...
                                            @else
                                                <option value="-"  @if($kelahiran->cacah_krama_mipil->penduduk->golongan_darah == '-') selected @endif>-</option>
                                                <option value="A" @if($kelahiran->cacah_krama_mipil->penduduk->golongan_darah == 'A') selected @endif>A</option>
                                                <option value="B" @if($kelahiran->cacah_krama_mipil->penduduk->golongan_darah == 'B') selected @endif>B</option>
                                                <option value="AB" @if($kelahiran->cacah_krama_mipil->penduduk->golongan_darah == 'AB') selected @endif>AB</option>
                                                <option value="O"  @if($kelahiran->cacah_krama_mipil->penduduk->golongan_darah == 'O') selected @endif>O</option>
                                            @endif
                                        </select>
                            ...
                            <div class="col-xxl-10 col-xl-11">  
                                        ...
                                        <div class="form-group" id="ayah_kandung_div">
                                            ...
                                            <select class="select2 custom-select @error ('ayah_kandung') is-invalid @enderror" name="ayah_kandung" id="ayah_kandung"  style="width: 100%" required>
                                                ...
                                                @if($krama_mipil->cacah_krama_mipil->penduduk->jenis_kelamin == 'laki-laki')
                                                    <option value="{{ $krama_mipil->cacah_krama_mipil->penduduk->id }}" @if($kelahiran->cacah_krama_mipil->penduduk->ayah_kandung_id == $krama_mipil->cacah_krama_mipil->penduduk->id) selected @endif>{{ $krama_mipil->cacah_krama_mipil->penduduk->nama }}</option>
                                                @endif
                                                @foreach($krama_mipil->anggota as $item)
                                                    @if($item->cacah_krama_mipil->penduduk->jenis_kelamin == 'laki-laki')
                                                        <option value="{{ $item->cacah_krama_mipil->penduduk->id }}" @if($kelahiran->cacah_krama_mipil->penduduk->ayah_kandung_id == $item->cacah_krama_mipil->penduduk->id) selected @endif>{{ $item->cacah_krama_mipil->penduduk->nama }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group" id="ibu_kandung_div">
                                            ...
                                            <select class="select2 custom-select @error ('ibu_kandung') is-invalid @enderror" name="ibu_kandung" id="ibu_kandung"  style="width: 100%" required>
                                                ...
                                                @if($krama_mipil->cacah_krama_mipil->penduduk->jenis_kelamin == 'perempuan')
                                                    <option value="{{ $krama_mipil->cacah_krama_mipil->penduduk->id }}" @if($kelahiran->cacah_krama_mipil->penduduk->ibu_kandung_id == $krama_mipil->cacah_krama_mipil->penduduk->id) selected @endif>{{ $krama_mipil->cacah_krama_mipil->penduduk->nama }}</option>
                                                @endif
                                                @foreach($krama_mipil->anggota as $item)
                                                    @if($item->cacah_krama_mipil->penduduk->jenis_kelamin == 'perempuan')
                                                        <option value="{{ $item->cacah_krama_mipil->penduduk->id }}" @if($kelahiran->cacah_krama_mipil->penduduk->ibu_kandung_id == $item->cacah_krama_mipil->penduduk->id) selected @endif>{{ $item->cacah_krama_mipil->penduduk->nama }}</option>
                                                    @endif
                                                @endforeach
                                            </select>
                                            {{-- <div class="custom-control custom-checkbox mb-n2">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control @error ('keterangan') is-invalid @enderror" placeholder="Masukkan Keterangan" rows="3" name="keterangan" id="keterangan">{{ $kelahiran->keterangan }}</textarea>
                                </div>
                                <hr class="my-4" />
