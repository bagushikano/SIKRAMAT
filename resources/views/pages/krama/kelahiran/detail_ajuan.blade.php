                ...
                <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                    <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                        ...
                        <div class="wizard-step-text">
                            <div class="wizard-step-text-name text-dark">Ajuan Data Kelahiran</div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-10 col-xl-10 mt-2">
                        <div class="row">
                            <div class="col-lg-12 col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-sm-12">
                                        <span class="text-dark font-weight-bold">: {{ date('d M Y', strtotime($kelahiran->tanggal_proses)) ?? '-' }}</span>
                                    </div>
                                </div>
                                @endif
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            @if($kelahiran->status == '2')
                                <a class="btn btn-success btn-icon-split mb-3 text-end" href="{{ route('Kelahiran Create Ajuan Ulang', $kelahiran->id) }}">
                                    <span class="icon">
                                        <i class="fas fa-clipboard-check"></i>
                                    </span>
                                    <span class="text">Ajukan Ulang Data Kelahiran</span>
                                </a>
                            @endif
                        </div>
                    </div>
