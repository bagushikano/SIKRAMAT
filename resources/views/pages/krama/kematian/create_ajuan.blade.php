                        ...
                        <div class="row justify-content-center">
                            <div class="col-xxl-10 col-xl-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control @error ('penyebab_kematian') is-invalid @enderror" placeholder="Masukkan Penyebab Kematian" rows="3" name="penyebab_kematian" id="penyebab_kematian" required>{{ old('penyebab_kematian') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control @error ('keterangan') is-invalid @enderror" placeholder="Masukkan Keterangan" rows="3" name="keterangan" id="keterangan">{{ old('keterangan') }}</textarea>
                                </div>
