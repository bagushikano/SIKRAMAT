                ...
                <div class="col-12 col-md-7 col-lg-8 col-xl-7">
                    <div class="card my-1">
                                        ...
                                        <div class="list-group">
                                            ...
                                            <div class="list-group-item list-group-item-action flex-column align-items-start">
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 col-md-7 col-lg-8">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            <p class="mb-1">{{ date('d M Y', strtotime($data['cacah_krama_tamiu']->nomor_cacah_krama_tamiu)) }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div class="card-footer">
                            <a href="{{ route('Dashboard Krama') }}" class="btn btn-sm btn-danger btn-icon-split text-end p-0">
                                <span class="icon">
