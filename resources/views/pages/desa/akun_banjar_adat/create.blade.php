...
@endpush
@section('title', 'Tambah Akun Banjar Adat')
@section('content')
    <main>
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('desa-admin-banjar-home') }}" class="text-decoration-none text-dark">Akun Banjar Adat</a></li>
                        <li class="breadcrumb-item active text-red-pastel">Tambah Akun</li>
                    </ol>
                </div>
            </div>
        </header>
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                ...
                                <div class="wizard-step-text-details text-dark">Lengkapi Formulir Penambahan Data Akun Banjar Adat Berikut Ini</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-xxl-10 col-xl-10 mt-4">
                            <form id="form-create-akun" method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('email') is-invalid @enderror" id="email" name="email" type="text" value="{{ old('email') }}" placeholder="Masukkan Alamat Email" required>
                                            @error('email')
                                                <div class="invalid-feedback text-start">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error ('nama') is-invalid @enderror" placeholder="Masukkan Nama Pengguna" name="nama" id="nama" value="{{ old('nama') }}" required>
                                            @error('nama')
                                                <div class="invalid-feedback text-start">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div>
                                        <button class="btn btn-success btn-icon-split text-end" onclick="simpan()">
                                            <span class="icon">
...
@push('js')
    ...
    <script>
        ...
        function simpan(){
            ...
            let confirm_pass = $('#confirm_password').val();
            if(pass == confirm_pass){
                var url = "{{ route('desa-admin-banjar-store') }}";
                $("#form-create-akun").attr("action", url);
                $('#form-create-akun').submit(function (e){
                    e.stopPropagation();
                });
            }else{
