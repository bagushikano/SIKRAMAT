...
@section('title', 'Laporan Data Tamiu')
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('banjar-laporan-krama-home') }}" class="text-decoration-none text-dark">Laporan Data Cacah Krama</a></li>
                        <li class="breadcrumb-item active  text-red-pastel">Laporan Cacah Tamiu</li>
                    </ol>
                </div>
            </div>
        </header>
        <div class="container mt-n10">
            ...
            <div class="card card-header-actions mt-4">
                <div class="card-header d-flex justify-content-center">
                    <p class="text-dark my-auto">Laporan Data Tamiu</p>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover small" id="tb_report">
                        <thead class="align-middle text-primary small">
                            <tr class="text-center">
                                ...
                                <th class="align-middle">Nomor<br>Cacah Tamiu</th>
                        ...
                        <tbody class="small">
                            @foreach ($data['tamiu'] as $tamiu)
                                <tr class="align-middle">
                                    ...
                                    <td class="align-middle">{{ $tamiu->nomor_cacah_tamiu }}</td>
                                    <td class="align-middle">{{ $tamiu->nama }}</td>
                                    <td class="align-middle">{{ $tamiu->tempat_lahir }},<br>{{ \Carbon\Carbon::parse($tamiu->tanggal_lahir)->locale('id')->translatedFormat('d M Y') }}</td>
                                    <td class="align-middle">{{ ucfirst($tamiu->jenis_kelamin) }}</td>
                                    <td class="align-middle">{{ $tamiu->banjar_adat->nama_banjar_adat ?? '-' }}</td>
                                    <td class="align-middle">{{ $tamiu->nama_banjar_dinas ?? '-' }}</td>
                                    <td class="align-middle">{{ $tamiu->jenjang_pendidikan }}</td>
                                    <td class="align-middle">{{ $tamiu->profesi }}</td>
                                    <td class="align-middle text-center">{{ $tamiu->golongan_darah }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
                ...
                <div class="card-footer py-2">
                    <div class="row">
                        <div class="col-12 my-auto">
                            <a href="{{ route('Pelaporan Krama Desa Adat') }}" class="btn btn-sm btn-danger btn-icon-split text-end p-0">
                                <span class="icon">
    ...
    <script>
        $(document).ready( function () {
            ...
            let tb_report = $("#tb_report").DataTable({
                ...
                "oLanguage": {
                    "sSearch": "Cari:",
                    "sSearchPlaceholder": "Rekap tamiu ...",
                    "sZeroRecords": "Tidak terdapat data rekap tamiu",
