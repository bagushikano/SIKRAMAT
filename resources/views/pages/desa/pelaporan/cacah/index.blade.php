...
@section('title', 'Laporan Data Cacah Krama')
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Laporan Data Cacah Krama</li>
                    </ol>
                </div>
            </div>
        </header>
            ...
            <div class="card my-1">
                <div class="card-header p-2 d-flex justify-content-center justify-content-lg-start justify-content-sm-start">
                    <ul class="nav nav-pills small">
                        <li class="nav-item"><a class="nav-link active" id="tabKramaMipil" href="#krama-mipil" data-toggle="tab">Filter Cacah Krama Mipil</a></li>
                        <li class="nav-item"><a class="nav-link" id="tabKramaTamiu" href="#krama-tamiu" data-toggle="tab">Filter Cacah Krama Tamiu</a></li>
                        <li class="nav-item"><a class="nav-link" id="tabTamiu" href="#tamiu" data-toggle="tab">Filter Cacah Tamiu</a></li>
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="krama-mipil">
                            <form action="" method="POST" class="form-horizontal needs-validation my-0" id="form_laporan_krama_mipil" enctype="multipart/form-data" novalidate>
                                ...
                                @if ($data['banjar_adat']->count() > 0)
                                    <div class="form-group">
                                        <label for="banjar_adat_mipil" class="form-label small mb-1">Banjar Adat<small class="text-danger">*</small></label>
                                        <select class="select2 select-banjar-adat-mipil form-select @error('banjar_adat_mipil[]') is-invalid @enderror" id="banjar_adat_mipil" multiple name="banjar_adat_mipil[]" required style="width: 100%">
                                            @foreach ($data['banjar_adat'] as $banjar_adat)
                                                <option value="{{ $banjar_adat->id }}">{{ $banjar_adat->nama_banjar_adat }}</option>
                                            @endforeach
                                        </select>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="select_banjar_adat_mipil">
                                            <label class="form-check-label small" for="select_banjar_adat_mipil">
                                                Pilih semua banjar adat
                                            </label>
                                        </div>
                                        @error('banjar_adat_mipil[]')
                                            <div class="invalid-feedback text-start">
                                                {{ $message }}
                                            </div>
                                        @else
                        ...
                        <div class="tab-pane" id="krama-tamiu">
                            <form id="form_laporan_krama_tamiu" action="" method="POST" class="form-horizontal needs-validation my-0" enctype="multipart/form-data" novalidate>
                                ...
                                @if ($data['banjar_adat']->count() > 0)
                                    <div class="form-group">
                                        <label for="banjar_adat_tamiu" class="form-label small mb-1">Banjar Adat<small class="text-danger">*</small></label>
                                        <select class="select2 select-banjar-adat-tamiu form-select @error('banjar_adat_tamiu[]') is-invalid @enderror" id="banjar_adat_tamiu" multiple name="banjar_adat_tamiu[]" required style="width: 100%">
                                            @foreach ($data['banjar_adat'] as $banjar_adat)
                                                <option value="{{ $banjar_adat->id }}">{{ $banjar_adat->nama_banjar_adat }}</option>
                                            @endforeach
                                        </select>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="select_banjar_adat_tamiu">
                                            <label class="form-check-label small" for="select_banjar_adat_tamiu">
                                                Pilih semua banjar adat
                                            </label>
                                        </div>
                                        @error('banjar_adat_tamiu[]')
                                            <div class="invalid-feedback text-start">
                                                {{ $message }}
                                            </div>
                                        @else
                        ...
                        <div class="tab-pane" id="tamiu">
                            <form id="form_laporan_tamiu" action="" method="POST" class="form-horizontal needs-validation my-0" enctype="multipart/form-data" novalidate>
                                ...
                                @if ($data['banjar_adat']->count() > 0)
                                    <div class="form-group">
                                        <label for="banjar_adat_tamu" class="form-label small mb-1">Banjar Adat<small class="text-danger">*</small></label>
                                        <select class="select2 select-banjar-adat-tamu form-select @error('banjar_adat_tamu[]') is-invalid @enderror" id="banjar_adat_tamu" multiple name="banjar_adat_tamu[]" required style="width: 100%">
                                            @foreach ($data['banjar_adat'] as $banjar_adat)
                                                <option value="{{ $banjar_adat->id }}">{{ $banjar_adat->nama_banjar_adat }}</option>
                                            @endforeach
                                        </select>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="select_banjar_adat_tamu">
                                            <label class="form-check-label small" for="select_banjar_adat_tamu">
                                                Pilih semua banjar adat
                                            </label>
                                        </div>
                                        @error('banjar_adat_tamu[]')
                                            <div class="invalid-feedback text-start">
                                                {{ $message }}
                                            </div>
                                        @else
                ...
                <div class="card-footer">
                    <a href="{{ route('Pelaporan Cacah Krama Desa Adat') }}" class="btn btn-sm btn-danger btn-icon-split text-end p-0">
                        <span class="icon">
...
@push('js')
    ...
    @if ($data['banjar_adat']->count() > 0)
        <script>
            $(document).ready( function () {
                $('.select-banjar-adat-mipil').select2({
                ...
                $("#select_banjar_adat_mipil").click(function(){
                    if($("#select_banjar_adat_mipil").is(':checked') ){
                        $(".select-banjar-adat-mipil").find('option').prop("selected",true);
                        $(".select-banjar-adat-mipil").trigger('change');
                    } else {
                        $(".select-banjar-adat-mipil").find('option').prop("selected",false);
                        $(".select-banjar-adat-mipil").trigger('change');
                    }
                });


                $('.select-banjar-adat-tamiu').select2({
                    placeholder: "Pilih banjar adat",
                    closeOnSelect: true,
                    language: {
                        noResults: function () {
                ...
                $("#select_banjar_adat_tamiu").click(function(){
                    if($("#select_banjar_adat_tamiu").is(':checked') ){
                        $(".select-banjar-adat-tamiu").find('option').prop("selected",true);
                        $(".select-banjar-adat-tamiu").trigger('change');
                    } else {
                        $(".select-banjar-adat-tamiu").find('option').prop("selected",false);
                        $(".select-banjar-adat-tamiu").trigger('change');
                    }
                });


                $('.select-banjar-adat-tamu').select2({
                    placeholder: "Pilih banjar adat",
                    closeOnSelect: true,
                    language: {
                        noResults: function () {
                ...
                $("#select_banjar_adat_tamu").click(function(){
                    if($("#select_banjar_adat_tamu").is(':checked') ){
                        $(".select-banjar-adat-tamu").find('option').prop("selected",true);
                        $(".select-banjar-adat-tamu").trigger('change');
                    } else {
                        $(".select-banjar-adat-tamu").find('option').prop("selected",false);
                        $(".select-banjar-adat-tamu").trigger('change');
                    }
                });
            })
    ...
    <script>
        $(document).ready( function () {
            ...
            $('#nav-link-laporan-cacah-krama').addClass('active');
    ...
    <script>
        function filter_mipil() {
            ...
            $('#form_laporan_krama_mipil').attr('action', "{{ route('Laporan Cacah Krama Mipil Desa Adat') }}");
        ...
        function download_pdf_mipil() {
            ...
            $('#form_laporan_krama_mipil').attr('action', "{{ route('Download PDF Laporan Cacah Krama Mipil Desa Adat') }}");
            $("#form_laporan_krama_mipil").submit(function(e) {
                e.stopPropagation();
            });
        }
        ...
        function download_excel_mipil() {
            $('#form_laporan_krama_mipil').attr('target', '_blank');
            $('#form_laporan_krama_mipil').attr('action', "{{ route('Download Excel Laporan Cacah Krama Mipil Desa Adat') }}");
            $("#form_laporan_krama_mipil").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
        function filter_tamiu() {
            ...
            $('#form_laporan_krama_tamiu').attr('action', "{{ route('Laporan Cacah Krama Tamiu Desa Adat') }}");
        ...
        function download_pdf_tamiu() {
            ...
            $('#form_laporan_krama_tamiu').attr('action', "{{ route('Download PDF Laporan Cacah Krama Tamiu Desa Adat') }}");
            $("#form_laporan_krama_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
        ...
        function download_excel_tamiu() {
            $('#form_laporan_krama_tamiu').attr('target', '_blank');
            $('#form_laporan_krama_tamiu').attr('action', "{{ route('Download Excel Laporan Cacah Krama Tamiu Desa Adat') }}");
            $("#form_laporan_krama_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
        function filter_tamu() {
            ...
            $('#form_laporan_tamiu').attr('action', "{{ route('Laporan Cacah Tamiu Desa Adat') }}");
        ...
        function download_pdf_tamu() {
            ...
            $('#form_laporan_tamiu').attr('action', "{{ route('Download PDF Laporan Cacah Tamiu Desa Adat') }}");
            $("#form_laporan_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
        ...
        function download_excel_tamu() {
            $('#form_laporan_tamiu').attr('target', '_blank');
            $('#form_laporan_tamiu').attr('action', "{{ route('Download Excel Laporan Cacah Tamiu Desa Adat') }}");
            $("#form_laporan_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
