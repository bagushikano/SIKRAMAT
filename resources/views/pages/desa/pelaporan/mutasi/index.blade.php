        ...
        <div class="container mt-n10">
            <div class="card my-1">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="kelahiran">
                            <form action="" method="POST" class="form-horizontal needs-validation my-0" id="form_laporan_kelahiran" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group">
                                    <label for="banjar_adat_kelahiran" class="small">Banjar Adat<span class="small text-danger">*</span></label>
                                    <select class="select2 custom-select select-desa-adat @error ('banjar_adat_kelahiran') is-invalid @enderror" name="banjar_adat_kelahiran[]" id="banjar_adat_kelahiran" multiple="multiple" style="width: 100%" aria-placeholder="Pilih Desa Adat" required>
                                        @foreach($banjar_adat as $banjar)
                                            <option value="{{ $banjar->id }}">{{ $banjar->nama_banjar_adat }}</option>
                                        @endforeach
                                    </select>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="pilih_semua_banjar_adat_kelahiran">
                                        <label class="form-check-label small" for="pilih_semua_banjar_adat_kelahiran">
                                            Pilih semua Banjar Adat
                                        </label>
                                    </div>
                                    @error('banjar_adat_kelahiran')
                                        <div class="invalid-feedback text-start">
                                            {{ $message }}
                                        </div>
                                    @else
                        ...
                        <div class="tab-pane" id="kematian">
                            <form action="" method="POST" class="form-horizontal needs-validation my-0" id="form_laporan_kematian" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group">
                                    <label for="banjar_adat_kematian" class="small">Banjar Adat<span class="small text-danger">*</span></label>
                                    <select class="select2 custom-select select-desa-adat @error ('banjar_adat_kematian') is-invalid @enderror" name="banjar_adat_kematian[]" id="banjar_adat_kematian" multiple="multiple" style="width: 100%" aria-placeholder="Pilih Banjar Adat" required>
                                        @foreach($banjar_adat as $banjar)
                                            <option value="{{ $banjar->id }}">{{ $banjar->nama_banjar_adat }}</option>
                                        @endforeach
                                    </select>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="pilih_semua_banjar_adat_kematian">
                                        <label class="form-check-label small" for="pilih_semua_banjar_adat_kematian">
                                            Pilih semua Banjar Adat
                                        </label>
                                    </div>
                                    @error('banjar_adat_kematian')
                                        <div class="invalid-feedback text-start">
                                            {{ $message }}
                                        </div>
                                    @else
                        ...
                        <div class="tab-pane" id="perkawinan">
                            <form action="" method="POST" class="form-horizontal needs-validation my-0" id="form_laporan_perkawinan" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group">
                                    <label for="banjar_adat_perkawinan" class="small">Banjar Adat<span class="small text-danger">*</span></label>
                                    <select class="select2 custom-select select-desa-adat @error ('banjar_adat_perkawinan') is-invalid @enderror" name="banjar_adat_perkawinan[]" id="banjar_adat_perkawinan" multiple="multiple" style="width: 100%" aria-placeholder="Pilih Banjar Adat" required>
                                        @foreach($banjar_adat as $banjar)
                                            <option value="{{ $banjar->id }}">{{ $banjar->nama_banjar_adat }}</option>
                                        @endforeach
                                    </select>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="pilih_semua_banjar_adat_perkawinan">
                                        <label class="form-check-label small" for="pilih_semua_banjar_adat_perkawinan">
                                            Pilih semua Banjar Adat
                                        </label>
                                    </div>
                                    @error('banjar_adat_perkawinan')
                                        <div class="invalid-feedback text-start">
                                            {{ $message }}
                                        </div>
                                    @else
                        ...
                        <div class="tab-pane" id="perceraian">
                            <form action="" method="POST" class="form-horizontal needs-validation my-0" id="form_laporan_perceraian" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group">
                                    <label for="banjar_adat_perceraian" class="small">Banjar Adat<span class="small text-danger">*</span></label>
                                    <select class="select2 custom-select select-desa-adat @error ('banjar_adat_perceraian') is-invalid @enderror" name="banjar_adat_perceraian[]" id="banjar_adat_perceraian" multiple="multiple" style="width: 100%" aria-placeholder="Pilih Banjar Adat" required>
                                        @foreach($banjar_adat as $banjar)
                                            <option value="{{ $banjar->id }}">{{ $banjar->nama_banjar_adat }}</option>
                                        @endforeach
                                    </select>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="pilih_semua_banjar_adat_perceraian">
                                        <label class="form-check-label small" for="pilih_semua_banjar_adat_perceraian">
                                            Pilih semua Banjar Adat
                                        </label>
                                    </div>
                                    @error('banjar_adat_perceraian')
                                        <div class="invalid-feedback text-start">
                                            {{ $message }}
                                        </div>
                                    @else
                        ...
                        <div class="tab-pane" id="maperas">
                            <form action="" method="POST" class="form-horizontal needs-validation my-0" id="form_laporan_maperas" enctype="multipart/form-data" novalidate>
                                ...
                                <div class="form-group">
                                    <label for="banjar_adat_maperas" class="small">Banjar Adat<span class="small text-danger">*</span></label>
                                    <select class="select2 custom-select select-desa-adat @error ('banjar_adat_maperas') is-invalid @enderror" name="banjar_adat_maperas[]" id="banjar_adat_maperas" multiple="multiple" style="width: 100%" aria-placeholder="Pilih Banjar Adat" required>
                                        @foreach($banjar_adat as $banjar)
                                            <option value="{{ $banjar->id }}">{{ $banjar->nama_banjar_adat }}</option>
                                        @endforeach
                                    </select>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="pilih_semua_banjar_adat_maperas">
                                        <label class="form-check-label small" for="pilih_semua_banjar_adat_maperas">
                                            Pilih semua Banjar Adat
                                        </label>
                                    </div>
                                    @error('banjar_adat_maperas')
                                        <div class="invalid-feedback text-start">
                                            {{ $message }}
                                        </div>
                                    @else
                ...
                <div class="card-footer">
                    <a href="{{ route('desa-dashboard') }}" class="btn btn-sm btn-danger btn-icon-split text-end p-0">
                        <span class="icon">
...
@push('js')
    ...
    <script>
        $(document).ready( function () {
            $('#banjar_adat_kelahiran').select2({
                placeholder: "Pilih Banjar Adat",
                closeOnSelect: true,
                language: {
                    noResults: function () {
                        return 'Tidak terdapat data yang sesuai';
            ...
            $("#pilih_semua_banjar_adat_kelahiran").click(function(){
                if($("#pilih_semua_banjar_adat_kelahiran").is(':checked') ){
                    $("#banjar_adat_kelahiran").find('option').prop("selected",true);
                    $("#banjar_adat_kelahiran").trigger('change');
                } else {
                    $("#banjar_adat_kelahiran").find('option').prop("selected",false);
                    $("#banjar_adat_kelahiran").trigger('change');
                }
            });
        });
        ...
        function filter_kelahiran() {
            ...
            $('#form_laporan_kelahiran').attr('action', "{{ route('Laporan Kelahiran Desa Adat') }}");
        ...
        function download_pdf_kelahiran() {
            $('#form_laporan_kelahiran').removeAttr('target');
            $('#form_laporan_kelahiran').attr('action', "{{ route('Download PDF Laporan Kelahiran Desa Adat') }}");
            $("#form_laporan_kelahiran").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
         $(document).ready( function () {
            ...
            $("#pilih_semua_banjar_adat_kematian").click(function(){
                if($("#pilih_semua_banjar_adat_kematian").is(':checked') ){
                    $("#banjar_adat_kematian").find('option').prop("selected",true);
                    $("#banjar_adat_kematian").trigger('change');
                } else {
                    $("#banjar_adat_kematian").find('option').prop("selected",false);
                    $("#banjar_adat_kematian").trigger('change');
                }
            });
        });
        ...
        function filter_kematian() {
            ...
            $('#form_laporan_kematian').attr('action', "{{ route('Laporan Kematian Desa Adat') }}");
        ...
        function download_pdf_kematian() {
            $('#form_laporan_kematian').removeAttr('target');
            $('#form_laporan_kematian').attr('action', "{{ route('Download PDF Laporan Kematian Desa Adat') }}");
            $("#form_laporan_kematian").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
        $(document).ready( function () {
            $('#banjar_adat_perkawinan').select2({
                placeholder: "Pilih Banjar Adat",
                closeOnSelect: true,
                language: {
                    noResults: function () {
            ...
            $("#pilih_semua_banjar_adat_perkawinan").click(function(){
                if($("#pilih_semua_banjar_adat_perkawinan").is(':checked') ){
                    $("#banjar_adat_perkawinan").find('option').prop("selected",true);
                    $("#banjar_adat_perkawinan").trigger('change');
                } else {
                    $("#banjar_adat_perkawinan").find('option').prop("selected",false);
                    $("#banjar_adat_perkawinan").trigger('change');
                }
            });
        });
        ...
        function filter_perkawinan() {
            ...
            $('#form_laporan_perkawinan').attr('action', "{{ route('Laporan Perkawinan Desa Adat') }}");
        ...
        function download_pdf_perkawinan() {
            $('#form_laporan_perkawinan').removeAttr('target');
            $('#form_laporan_perkawinan').attr('action', "{{ route('Download PDF Laporan Perkawinan Desa Adat') }}");
            $("#form_laporan_perkawinan").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
         $(document).ready( function () {
            $('#banjar_adat_perceraian').select2({
                placeholder: "Pilih Banjar Adat",
                closeOnSelect: true,
                language: {
                    noResults: function () {
            ...
            $("#pilih_semua_banjar_adat_perceraian").click(function(){
                if($("#pilih_semua_banjar_adat_perceraian").is(':checked') ){
                    $("#banjar_adat_perceraian").find('option').prop("selected",true);
                    $("#banjar_adat_perceraian").trigger('change');
                } else {
                    $("#banjar_adat_perceraian").find('option').prop("selected",false);
                    $("#banjar_adat_perceraian").trigger('change');
                }
            });
        });
        ...
        function filter_perceraian() {
            ...
            $('#form_laporan_perceraian').attr('action', "{{ route('Laporan Perceraian Desa Adat') }}");
        ...
        function download_pdf_perceraian() {
            $('#form_laporan_perceraian').removeAttr('target');
            $('#form_laporan_perceraian').attr('action', "{{ route('Download PDF Laporan Perceraian Desa Adat') }}");
            $("#form_laporan_perceraian").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
        $(document).ready( function () {
            ...
            $("#pilih_semua_banjar_adat_maperas").click(function(){
                if($("#pilih_semua_banjar_adat_maperas").is(':checked') ){
                    $("#banjar_adat_maperas").find('option').prop("selected",true);
                    $("#banjar_adat_maperas").trigger('change');
                } else {
                    $("#banjar_adat_maperas").find('option').prop("selected",false);
                    $("#banjar_adat_maperas").trigger('change');
                }
            });
        });
        ...
        function filter_maperas() {
            ...
            $('#form_laporan_maperas').attr('action', "{{ route('Laporan Maperas Desa Adat') }}");
        ...
        function download_pdf_maperas() {
            $('#form_laporan_maperas').removeAttr('target');
            $('#form_laporan_maperas').attr('action', "{{ route('Download PDF Laporan Maperas Desa Adat') }}");
            $("#form_laporan_maperas").submit(function(e) {
                e.stopPropagation();
            });
        }
