...
@section('title', 'Laporan Data Krama Tamiu')
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Laporan Krama Tamiu</li>
                    </ol>
                </div>
            </div>
        </header>
        <div class="container mt-n10">
            ...
            <div class="card card-header-actions mt-4">
                <div class="card-header d-flex justify-content-center">
                    <p class="text-dark my-auto">Laporan Data Krama Tamiu</p>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover small" id="tb_report">
                        <thead class="align-middle text-primary small">
                            <tr class="text-center">
                                ...
                                <th class="align-middle">Nomor<br>Krama Tamiu</th>
                        ...
                        <tbody class="small">
                            @foreach ($data['krama_tamiu'] as $krama_tamiu)
                                <tr class="align-middle">
                                    ...
                                    <td class="align-middle">{{ $krama_tamiu->nomor_krama_tamiu }}</td>
                                    ...
                                    <td class="align-middle">{{ $krama_tamiu->nama_banjar_adat ?? '-' }}</td>
    ...
    <script>
        $(document).ready( function () {
            ...
            let tb_report = $("#tb_report").DataTable({
                ...
                "oLanguage": {
                    "sSearch": "Cari:",
                    "sSearchPlaceholder": "Rekap krama tamiu ...",
                    "sZeroRecords": "Tidak terdapat data rekap krama tamiu",
