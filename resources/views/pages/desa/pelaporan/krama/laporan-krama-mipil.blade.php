...
@section('title', 'Laporan Data Krama Mipil')
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('banjar-laporan-krama-home') }}" class="text-decoration-none text-dark">Laporan Data Krama</a></li>
                        <li class="breadcrumb-item active text-red-pastel">Laporan Krama Mipil</li>
                    </ol>
                </div>
            </div>
        </header>
        <div class="container mt-n10">
            ...
            <div class="card card-header-actions mt-4">
                <div class="card-header d-flex justify-content-center">
                    <p class="text-dark my-auto">Laporan Data Krama Mipil</p>
                </div>
                <div class="card-body">
                    <table class="table table-bordered table-hover small" id="tb_report">
                        <thead class="align-middle text-primary small">
                            <tr class="text-center">
                                ...
                                <th class="align-middle">Nomor<br>Krama Mipil</th>
                        ...
                        <tbody class="small">
                            @foreach ($data['krama_mipil'] as $krama_mipil)
                                <tr class="align-middle">
                                    ...
                                    <td class="align-middle">{{ $krama_mipil->nomor_krama_mipil }}</td>
                                    ...
                                    <td class="align-middle">{{ $krama_mipil->nama_banjar_adat ?? '-' }}</td>
...
@push('js')
    ...
    <script>
        $(document).ready( function () {
            ...
            let tb_report = $("#tb_report").DataTable({
                ...
                "oLanguage": {
                    "sSearch": "Cari:",
                    "sSearchPlaceholder": "Rekap krama mipil ...",
                    "sZeroRecords": "Tidak terdapat data rekap krama mipil",
    ...
    <script>
        $(document).ready( function () {
            const banjar_adat_data = {
                labels: {!!json_encode($data['nama_banjar_adat'])!!},
                datasets: [
                    {
                        data: {!!json_encode($data['grafik_banjar_adat_laki']['jumlah'])!!},
                    ...
                    {
                        data: {!!json_encode($data['grafik_banjar_adat_perempuan']['jumlah'])!!},
            ...
            const banjar_adat_config = {
                type: 'bar',
                data: banjar_adat_data,
                options: {
                    interaction: {
                        intersect: false,
                    },
            ...
            let jenisBanjarAdatChart = new Chart(
                document.getElementById('banjar_adat'),
                banjar_adat_config
            );
        });
    </script>
