        ...
        <div class="container mt-n15">
            ...
            <div class="card mb-4 mt-4">
                ...
                <div class="card-body">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{ route('desa-cacah-tamiu-wna-store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                        <div class="row mx-5">
                        ...
                        <div class="row mx-5">
                            <div class="col-lg-6 col-sm-12 py-2">
                                ...
                                <select class="select2 custom-select @error ('negara') is-invalid @enderror" name="negara" id="negara" style="width: 100%" required aria-placeholder="Pilih Negara Asal" required disabled>
                                    <option value="">Pilih Negara Asal</option>
                                    {{-- @foreach($negaras as $negara)
                                        <option value="{{ $negara->id }}" @if(old('negara') == $negara->id) selected @endif>{{ $negara->code }} - {{ $negara->name }}</option>
                                    @endforeach --}}
                                </select>
                                @error('negara')
                                    <div class="invalid-feedback text-start">
        ...
        $(document).ready( function () {
            ...
            $('#search_button').on('click', function(){
                if($("#nomor_paspor").val().length != 8){
                    ...
                    var url = "{{ route('desa-cacah-tamiu-get-wna', ":nomor_paspor") }}";
