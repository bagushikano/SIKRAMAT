    ...
    <main>
        ...
        <div class="container mt-n15">
            ...
            <div class="card mb-4 mt-4">
                <div class="card-header">Masukkan Data Cacah Krama Tamiu</div>
                <div class="card-body">
                    <div id="overlay">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{ route('desa-cacah-krama-tamiu-store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                        <div class="row mx-5">
                        ...
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-6 col-sm-12 py-2">
                                ...
                                <input type="text" class="form-control @error ('nama_alias') is-invalid @enderror" id="nama_alias" name="nama_alias" placeholder="Masukkan Nama Panggilan" value="{{ old('nama_alias') }}" readonly>
                                @error('nama_alias')
                                    <div class="invalid-feedback text-start">
                                        {{ $message }}
                                    </div>
        ...
        $(document).ready( function () {
            ...
            $('#search_button').on('click', function(){
                if($("#nik").val().length != 16){
                    ...
                    var url = "{{ route('desa-cacah-krama-tamiu-get-penduduk', ":nik") }}";
            ...
            $(".select-krama").select2({
                ...
                ajax: {
                    url: '{{ route("api-cacah-krama-tamiu-ortu-search") }}',
                    dataType: 'json',
                },
            });
