        ...
        <div class="container mt-n15">
            ...
            <div class="card mb-4 mt-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mx-5">
                        <div class="col-lg-3 col-sm-3">
                            <label for="nomor_cacah_krama_tamiu">Nomor Induk Cacah Krama</label>
                        </div>
                        <div class="col-lg-9 col-sm-9">
                    ...
                    <div class="row mx-5 mt-3 mb-2">
                        <div class="col-lg-6 col-sm-12">
                            <a class="btn btn-danger" href="{{ route('desa-cacah-krama-tamiu-home') }}">Kembali</a><a class="btn btn-warning ml-2" href="{{ route('desa-cacah-krama-tamiu-edit', $krama->id) }}">Edit</a>
                        </div>
                    </div>
                </div>
            </div>
