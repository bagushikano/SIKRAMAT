    ...
    <main>
        ...
        <div class="container mt-n15">
            ...
            <div class="card mb-4 mt-4">
                <div class="card-header">Data Krama Tamiu</div>
                <div class="card-body">
                    <div id="overlay">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{ route('desa-cacah-krama-tamiu-update', $krama->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                    <div class="row mx-5">
                        ...
                        <div class="col-lg-6 col-sm-12 py-2">
                            <label for="title">Nomor Cacah Krama Tamiu<span class="text-danger small">*</span></label>
                            <input type="text" class="form-control @error ('nomor_cacah_krama_tamiu') is-invalid @enderror" id="nomor_cacah_krama_tamiu" name="nomor_cacah_krama_tamiu" value="{{ $krama->nomor_cacah_krama_tamiu }}" required disabled>
                            @error('nomor_cacah_krama_tamiu')
                                <div class="invalid-feedback text-start">
                                    {{ $message }}
                                </div>
                            @else
                                <div class="invalid-feedback">
                                    Nomor Cacah Krama Tamiu wajib diisi
                                </div>
                            @enderror
                        </div>
                    </div>
                        ...
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-6 col-sm-12 py-2">
                                ...
                                <input type="text" class="form-control @error ('nama_alias') is-invalid @enderror" id="nama_alias" name="nama_alias" placeholder="Masukkan Nama Panggilan" value="{{ old('nama_alias', $penduduk->nama_alias) }}" required>
                                @error('nama_alias')
                                    <div class="invalid-feedback text-start">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-6 col-sm-12 py-2">
                                ...
                                <input type="text" class="datepicker-here form-control @error ('tanggal_keluar') is-invalid @enderror" placeholder="dd mmm yyyy" name="tanggal_keluar" id="tanggal_keluar" placeholder="Masukkan Keluar Masuk Krama Mipil"  value="@if($krama->tanggal_keluar != NULL) {{ old('tanggal_lahir',date('d M Y', strtotime($krama->tanggal_keluar))) }} @endif">
                        ...
                        <div class="row mx-5 mt-3">
                            <div class="col-lg-6 col-sm-12 py-2">
                                <a class="btn btn-danger mr-2" href="{{ route('desa-cacah-krama-tamiu-home') }}">Kembali</a><button class="btn btn-success" type="submit">Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
