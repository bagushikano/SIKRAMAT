...
@endpush
@section('title', 'Daftar Perkawinan Satu Desa')
@section('content')
    <main>
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Perkawinan Dalam Desa Adat</li>
                    </ol>
                </div>
            </div>
        </header>
        ...
        <div class="container mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">Perkawinan Dalam <span class="text-dark">Desa Adat {{ Session::get('desa_adat_nama') }}</span></div>
                <div class="card-body">
                    <a class="btn btn-primary btn-icon-split mb-3 text-end" href="{{ route('desa-perkawinan-dalam-desa-adat-create') }}">
                        <span class="icon">
    ...
    {{-- HIDDEN FORM --}}
    <form id="form-delete-keluarga" method="post" action="/">
        @method('delete')
        @csrf
    </form>
@endsection
