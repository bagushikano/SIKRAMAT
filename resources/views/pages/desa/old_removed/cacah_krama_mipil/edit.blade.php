    ...
    <main>
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('desa-cacah-krama-mipil-home') }}" class="text-decoration-none">Cacah Krama Mipil</a></li>
        ...
        <div class="container mt-n15">
            ...
            <div class="card mb-4 mt-4">
                <div class="card-header">Data Cacah Krama Mipil</div>
                <div class="card-body">
                    <div id="overlay">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{ route('desa-cacah-krama-mipil-update', $krama->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @csrf
                        <div class="row mx-5">
                            <div class="col-lg-6 col-sm-12 py-2">
                                <div class="form-group">
                                    <label for="title">Nomor Induk Cacah Krama<span class="text-danger small">*</span></label>
                                    <input type="text" class="form-control @error ('nomor_induk_cacah_krama') is-invalid @enderror" id="nomor_induk_cacah_krama" name="nomor_induk_cacah_krama" value="{{ $penduduk->nomor_induk_cacah_krama }}" required disabled>
                                    @error('nomor_induk_cacah_krama')
                                        <div class="invalid-feedback text-start">
                                            {{ $message }}
                                        </div>
                                    @else
                                        <div class="invalid-feedback">
                                            Nomor Induk Cacah Krama wajib diisi
                                        </div>
                                    @enderror
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-12 py-2">
                                <label for="title">Nomor Cacah Krama Mipil<span class="text-danger small">*</span></label>
                                <input type="text" class="form-control @error ('nomor_cacah_krama_mipil') is-invalid @enderror" id="nomor_cacah_krama_mipil" name="nomor_cacah_krama_mipil" value="{{ $krama->nomor_cacah_krama_mipil }}" required disabled>
                                @error('nomor_cacah_krama_mipil')
                                    <div class="invalid-feedback text-start">
                                        {{ $message }}
                                    </div>
                                @else
                                    <div class="invalid-feedback">
                                        Nomor Cacah Krama Mipil wajib diisi
                                    </div>
                                @enderror
                            </div>
                        </div>
                        ...
                        <div class="row mx-5">
                            <div class="col-lg-6 col-sm-12 py-2">
                                ...
                                <select class="select2 custom-select @error('jenis_kependudukan') is-invalid @enderror" name="jenis_kependudukan" id="jenis_kependudukan"  style="width: 100%" required aria-placeholder="Pilih jenis kependudukan" required>
                                    ...
                                    @else 
                                        <option value="adat_&_dinas" @if($krama->jenis_kependudukan == 'adat_&_dinas') selected @endif>Adat dan Dinas</option>
                                        <option value="adat" @if($krama->jenis_kependudukan == 'adat') selected @endif>Adat</option>
                                    @endif
                                </select>
                        ...
                        <div class="row mx-5">
                            <div class="col-lg-6 col-sm-12 py-2" id="banjar_dinas_row" @if($krama->jenis_kependudukan != 'adat_&_dinas') style="display:none;" @endif>
                                <label for="title">Banjar Dinas<span class="text-danger small">*</span></label>
                                <select class="select2 custom-select @error('banjar_dinas_id') is-invalid @enderror" name="banjar_dinas_id" id="banjar_dinas"  style="width: 100%" aria-placeholder="Pilih Banjar Dinas" @if($krama->jenis_kependudukan == 'adat_&_dinas') required @endif>
                        ...
                        <div class="row mx-5 mt-3">
                            <div class="col-lg-6 col-sm-12 py-2">
                                <a class="btn btn-danger mr-2" href="{{ route('desa-cacah-krama-mipil-home') }}">Kembali</a><button class="btn btn-success" type="submit">Simpan</button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        $(".select-krama").select2({
            language: {
                ...
                inputTooShort: function() {
                    return 'Masukkan NIK atau Nomor Induk Cacah Krama';
                }
            },
            minimumInputLength: 16,
            ajax: {
                url: '{{ route("api-cacah-krama-mipil-ortu-search") }}',
                dataType: 'json',
            },
        });
