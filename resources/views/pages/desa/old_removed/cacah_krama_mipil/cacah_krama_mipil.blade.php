...
@section('content')
    <main>
        ...
        <div class="container mt-n10">
            ...
            <div class="card mb-4">
                <div class="card-header">Cacah Krama Mipil <span class="text-dark">Desa Adat {{ Session::get('desa_adat_nama') }}</span></div>
                <div class="card-body">
                    <a class="btn btn-primary btn-icon-split mb-3 text-end" href="{{ route('desa-cacah-krama-mipil-create') }}">
                        <span class="icon">
                            ...
                            <tbody>
                                @foreach($kramas as $krama)
                                    <tr>
                                        ...
                                        <td>{{ ucwords(str_replace('_', ' ', $krama->jenis_kependudukan)) }}</td>
                                        <td>{{ $krama->banjar_adat->nama_banjar_adat }}</td>
                                        <td class="text-center">
                                            <a class="btn btn-primary btn-sm"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Detail" href="{{ route('desa-cacah-krama-mipil-detail', $krama->id) }}"><i class="fas fa-eye"></i></a>
                                            <a class="btn btn-warning btn-sm"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{ route('desa-cacah-krama-mipil-edit', $krama->id) }}"><i class="fas fa-edit"></i></a>
...
@push('js')
    ...
    <script>
        function delete_krama(id){
            Swal.fire({
                title: 'Hapus Krama',
                text: "Apakah anda yakin ingin menghapus Krama Mipil ini?",
                icon: 'warning',
