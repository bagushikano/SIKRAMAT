...
@endpush
@section('title', 'Detail Cacah Krama Mipil')
@section('content')
    <main>
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Detail Cacah Krama Mipil</li>
                    </ol>
                </div>
            </div>
        </header>
        ...
        <div class="container mt-n15">
            ...
            <div class="card mb-4 mt-4">
                <div class="card-header">Data Pribadi Cacah Krama Mipil</div>
                <div class="card-body">
                    ...
                    <div class="row mx-5">
                        <div class="col-lg-3 col-sm-3">
                            <label for="nomor_cacah_krama_mipil">Nomor Induk Cacah Krama</label>
                        </div>
                        <div class="col-lg-9 col-sm-9">
                            <span class="text-dark font-weight-bold">: {{ substr($penduduk->nomor_induk_cacah_krama,0,4) }}-{{ substr($penduduk->nomor_induk_cacah_krama,4,2) }}-{{ substr($penduduk->nomor_induk_cacah_krama,6,6) }}-{{ substr($penduduk->nomor_induk_cacah_krama,12,3) }}</span>
                        </div>
                    </div>
                    ...
                    <div class="row mx-5">
                        <div class="col-lg-3 col-sm-3">
                            <label for="jenis_kependudukan">Jenis Kependudukan</label>
                        </div>
                        <div class="col-lg-9 col-sm-9">
                            <span class="text-dark font-weight-bold">: {{ ucwords(str_replace('_', ' ', $krama->jenis_kependudukan)) ?? '-' }}</span>
                        </div>
                    </div>
                    ...
                    <div class="row mx-5 mt-3 mb-2">
                        <div class="col-lg-6 col-sm-12">
                            <a class="btn btn-danger" href="{{ route('desa-cacah-krama-mipil-home') }}">Kembali</a><a class="btn btn-warning ml-2" href="{{ route('desa-cacah-krama-mipil-edit', $krama->id) }}">Edit</a>
                        </div>
                    </div>
                </div>
