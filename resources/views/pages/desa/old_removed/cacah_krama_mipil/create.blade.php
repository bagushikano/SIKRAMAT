    ...
    <main>
        ...
        <div class="container mt-n15">
            ...
            <div class="card mb-4 mt-4">
                <div class="card-header">Masukkan Data Cacah Krama Mipil</div>
                <div class="card-body">
                    <div id="overlay">
                    ...
                    @csrf
                        ...
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-6 col-sm-12 py-2">
                                ...
                                <input type="text" class="form-control @error ('nama_alias') is-invalid @enderror" id="nama_alias" name="nama_alias" placeholder="Masukkan Nama Alias" value="{{ old('nama_alias') }}" readonly>
                                @error('nama_alias')
                                    <div class="invalid-feedback text-start">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mx-5">
                            <div class="col-lg-6 col-sm-12 py-2">
                                ...
                                <input type="text" class="form-control @error ('tempat_lahir') is-invalid @enderror" id="tempat_lahir" name="tempat_lahir" value="{{ old('tempat_lahir') }}" placeholder="Masukkan Tempat Lahir" required readonly>
                                @error('tempat_lahir')
                                    <div class="invalid-feedback text-start">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row mx-5">
                            ...
                            <div class="col-lg-6 col-sm-12 py-2">
                                ...
                                <select class="select2 custom-select @error ('jenis_kependudukan') is-invalid @enderror" name="jenis_kependudukan" id="jenis_kependudukan"  style="width: 100%" required aria-placeholder="Pilih jenis kependudukan" required disabled>
        ...
        $(document).ready( function () {
            ...
            $('#search_button').on('click', function(){
                if($("#nik").val().length != 16){
                    ...
                    var url = "{{ route('desa-cacah-krama-mipil-get-penduduk', ":nik") }}";
