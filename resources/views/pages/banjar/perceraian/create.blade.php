...
@endpush
@section('title', 'Tambah Perceraian')
@section('content')
    <main>
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Tambah Perceraian</li>
                    </ol>
                </div>
            </div>
        </header>
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                ...
                                <div class="wizard-step-text-details text-dark">Lengkapi Formulir Penambahan Data Perceraian Berikut Ini</div>
                            </div>
                        </a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-xxl-10 col-xl-11 mt-4">
                            <form id="form-create-perceraian" method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('kedudukan_krama_mipil') is-invalid @enderror" id="kedudukan_krama_mipil" name="kedudukan_krama_mipil" placeholder="Kedudukan Krama Mipil" value="" disabled>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9 col-sm-9">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control @error ('krama_mipil_baru_krama_mipil') is-invalid @enderror"  id="krama_mipil_baru_krama_mipil" name="krama_mipil_baru_krama_mipil"  value="{{ old('krama_mipil_baru_krama_mipil') }}" required hidden>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('kedudukan_pasangan') is-invalid @enderror" id="kedudukan_pasangan" name="kedudukan_pasangan" placeholder="Kedudukan Pasangan" value="" disabled>
                                            </div>
                                        </div>
                                        <div class="col-lg-8 col-sm-9">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9 col-sm-9">
                                                <div class="form-group">
                                                    <label for="title" class="small">Krama Mipil Baru<span class="text-danger small">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" class="form-control @error ('krama_mipil_baru_pasangan_placeholder') is-invalid @enderror form-custom"  id="krama_mipil_baru_pasangan_placeholder" name="krama_mipil_baru_pasangan_placeholder" placeholder="Pilih Krama Mipil Baru" value="{{ old('krama_mipil_baru_pasangan_placeholder') }}" required readonly>
                                                        <div class="input-group-append">
                                                    ...
                                                    <input type="text" class="form-control @error ('krama_mipil_baru_pasangan') is-invalid @enderror"  id="krama_mipil_baru_pasangan" name="krama_mipil_baru_pasangan"  value="{{ old('krama_mipil_baru_pasangan') }}" required hidden>
                                ...
                                <div id="data-anggota-keluarga">
                                    ...
                                    <div id="anggota-keluarga-0">
                                        <div class="alert alert-info text-center" id="alert-anggota-keluarga" role="alert">
                                            <i class="fas fa-exclamation-circle mr-1"></i> Pilih Krama Mipil terlebih dahulu.
                                        </div>
                                    </div>
                                    <div id="anggota-keluarga-isi" style="display: none;">
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="datepicker-here form-control @error ('tanggal_perceraian') is-invalid @enderror" placeholder="Masukkan Tanggal Perceraian" name="tanggal_perceraian" id="tanggal_perceraian" value="{{ old('tanggal_perceraian') }}" required>
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nama_pemuput') is-invalid @enderror"  id="nama_pemuput" name="nama_pemuput" placeholder="Masukkan Nama Pemuput Perceraian" value="{{ old('nama_pemuput') }}" required>
                                                @error('nama_pemuput')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nomor_bukti_perceraian') is-invalid @enderror"  id="nomor_bukti_perceraian" name="nomor_bukti_perceraian" placeholder="Masukkan No. Bukti Perceraian" value="{{ old('nomor_bukti_perceraian') }}" required>
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input @error('file_bukti_perceraian') is-invalid @enderror" id="file_bukti_perceraian" name="file_bukti_perceraian" accept=".pdf, .jpg" required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nomor_akta_perceraian') is-invalid @enderror"  id="nomor_akta_perceraian" name="nomor_akta_perceraian" placeholder="Masukkan No. Akta Perceraian" value="{{ old('nomor_akta_perceraian') }}">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div>
                                        <button class="btn btn-success btn-icon-split text-end" onclick="simpan_perceraian('0')">
                                            <span class="icon">
                                        ...
                                        <button class="btn btn-success btn-icon-split text-end" onclick="simpan_perceraian('3')">
                                            <span class="icon">
                                                <i class="fas fa-save"></i>
                                            </span>
...
@push('js')
    ...
    <script>
        ...
        function simpan_perceraian(status){
            var url = "{{ route('banjar-perceraian-store', ":status") }}";
            url = url.replace(':status', status);
            $("#form-create-perceraian").attr("action", url);
            $('#form-create-perceraian').submit(function (e){
                e.stopPropagation();
            });
        }
