        ...
        <div class="container mt-n10">
            ...
            <div class="card card-header-actions mb-4">
                <div class="card-header">
                    <div>
                        Cacah Krama Tamiu <span class="text-dark">Banjar Adat {{ Session::get('banjar_adat_nama') }}</span>
                    </div>
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <div class="col-12 col-md-10">
                            <a class="btn btn-primary btn-icon-split mb-3 text-end" href="{{ route('banjar-cacah-krama-tamiu-create') }}">
                                <span class="icon">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-gray-100">
                    <h5 class="modal-title" id="exampleModalLabel">Filter Data Cacah Krama Tamiu</h5>
                ...
                <div class="modal-body mx-3">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="status" class="small">Status Cacah Krama Tamiu</label>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="asal" class="small">Asal</label>
                                <select class="select2 custom-select @error ('asal') is-invalid @enderror" name="asal" id="asal" style="width: 100%" aria-placeholder="Pilih Status Kelahiran" required>
                                    <option value="">Semua Asal</option>
                                    <option value="dalam_bali">Dalam Bali</option>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="select2 custom-select @error ('jenis_kelamin') is-invalid @enderror" name="jenis_kelamin" id="jenis_kelamin" style="width: 100%" aria-placeholder="Pilih Asal" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="rentang_waktu_masuk" class="small">Rentang Tanggal Masuk</label>
                                <input type="text" class="form-control" name="rentang_waktu_masuk" id="rentang_waktu_masuk" placeholder="Pilih Rentang Tanggal Masuk" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                <form id="form-delete-anggota" method="post" action="#" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Keluarkan Cacah Krama Tamiu</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    </div>
...
@push('js')
    ...
    <script>
        function delete_krama(id){
            var url = "{{ route('banjar-cacah-krama-tamiu-delete', ":id") }}";
        ...
        $(document).ready( function () {
            ...
            $('#rentang_waktu_masuk').daterangepicker({
                // minDate: "01 Jan 2022",
                locale: {
                    format: 'DD MMM YYYY',
                    daysOfWeek: [
        ...
        var TableDatatablesEditable = function () {
            var handleTable = function () {
                var table = $('#dataTable-cacah-krama-tamiu');
                var oTable = table.DataTable({
                    ...
                    ajax: {
                        url : "{{ route('banjar-cacah-krama-tamiu-datatable') }}",
                        data : function(d){
                            d.status = $('#status').val();
                            d.rentang_waktu = $('#rentang_waktu').val();
                            d.asal = $('#asal').val();
                            d.rentang_waktu_masuk = $('#rentang_waktu_masuk').val();
                    ...
                    columns: [
                        ...
                        { data: 'nomor_cacah_krama_tamiu', class: "wrap", orderable: false },
