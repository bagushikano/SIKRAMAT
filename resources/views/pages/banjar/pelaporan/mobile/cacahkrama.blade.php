...
<html lang="en">
    ...
    <script>
        function download_pdf_mipil() {
            ...
            $('#form_laporan_krama_mipil').attr('action', "{{ route('PDF Cacah Krama Mipil', $data['banjar_adat_id']) }}");
        ...
        function download_excel_mipil() {
            $('#form_laporan_krama_mipil').attr('target', '_blank');
            $('#form_laporan_krama_mipil').attr('action', "{{ route('Excel Cacah Krama Mipil', $data['banjar_adat_id']) }}");
            $("#form_laporan_krama_mipil").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
        function download_pdf_tamiu() {
            ...
            $('#form_laporan_krama_tamiu').attr('action', "{{ route('PDF Cacah Krama Tamiu', $data['banjar_adat_id']) }}");
        ...
        function download_excel_tamiu() {
            $('#form_laporan_krama_tamiu').attr('target', '_blank');
            $('#form_laporan_krama_tamiu').attr('action', "{{ route('Excel Cacah Krama Tamiu', $data['banjar_adat_id'] ) }}");
            $("#form_laporan_krama_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
        function download_pdf_tamu() {
            ...
            $('#form_laporan_tamiu').attr('action', "{{ route('PDF Cacah Tamiu', $data['banjar_adat_id']) }}");
        ...
        function download_excel_tamu() {
            $('#form_laporan_tamiu').attr('target', '_blank');
            $('#form_laporan_tamiu').attr('action', "{{ route('Excel Cacah Tamiu', $data['banjar_adat_id']) }}");
            $("#form_laporan_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
