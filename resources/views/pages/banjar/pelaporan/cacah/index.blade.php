...
@push('js')
    ...
    <script>
        function filter_mipil() {
            ...
            $('#form_laporan_krama_mipil').attr('action', "{{ route('Laporan Cacah Krama Mipil') }}");
        ...
        function download_pdf_mipil() {
            ...
            $('#form_laporan_krama_mipil').attr('action', "{{ route('Download PDF Laporan Cacah Krama Mipil') }}");
            $("#form_laporan_krama_mipil").submit(function(e) {
                e.stopPropagation();
            });
        }
        ...
        function download_excel_mipil() {
            $('#form_laporan_krama_mipil').attr('target', '_blank');
            $('#form_laporan_krama_mipil').attr('action', "{{ route('Download Excel Laporan Cacah Krama Mipil') }}");
            $("#form_laporan_krama_mipil").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
        function filter_tamiu() {
            ...
            $('#form_laporan_krama_tamiu').attr('action', "{{ route('Laporan Cacah Krama Tamiu') }}");
        ...
        function download_pdf_tamiu() {
            ...
            $('#form_laporan_krama_tamiu').attr('action', "{{ route('Download PDF Laporan Cacah Krama Tamiu') }}");
            $("#form_laporan_krama_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
        ...
        function download_excel_tamiu() {
            $('#form_laporan_krama_tamiu').attr('target', '_blank');
            $('#form_laporan_krama_tamiu').attr('action', "{{ route('Download Excel Laporan Cacah Krama Tamiu') }}");
            $("#form_laporan_krama_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
    ...
    <script>
        function filter_tamu() {
            ...
            $('#form_laporan_tamiu').attr('action', "{{ route('Laporan Cacah Tamiu') }}");
        ...
        function download_pdf_tamu() {
            ...
            $('#form_laporan_tamiu').attr('action', "{{ route('Download PDF Laporan Cacah Tamiu') }}");
            $("#form_laporan_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
        ...
        function download_excel_tamu() {
            $('#form_laporan_tamiu').attr('target', '_blank');
            $('#form_laporan_tamiu').attr('action', "{{ route('Download Excel Laporan Cacah Tamiu') }}");
            $("#form_laporan_tamiu").submit(function(e) {
                e.stopPropagation();
            });
        }
