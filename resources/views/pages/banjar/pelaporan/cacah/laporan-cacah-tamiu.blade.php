...
@section('title', 'Laporan Data Cacah Tamiu')
        ...
        <div class="container mt-n10">
            ...
            <div class="card card-header-actions mt-4">
                <div class="card-header d-flex justify-content-center">
                    <p class="text-dark my-auto">Laporan Data Cacah Tamiu</p>
                </div>
                <div class="card-body">
    ...
    <script>
        $(document).ready( function () {
            ...
            let tb_report = $("#tb_report").DataTable({
                ...
                "oLanguage": {
                    "sSearch": "Cari:",
                    "sSearchPlaceholder": "Rekap cacah tamiu ...",
                    "sZeroRecords": "Tidak terdapat data rekap cacah tamiu",
