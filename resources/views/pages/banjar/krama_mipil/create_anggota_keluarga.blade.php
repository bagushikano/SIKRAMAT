            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('banjar-krama-mipil-detail', $krama_mipil->id) }}" class="text-decoration-none text-dark">Krama Mipil</a></li>
        ...
        <div class="container mt-n15">
            <div class="card mb-4 mt-4">
                ...
                <div class="card-body">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{route('banjar-anggota-krama-mipil-store', $krama_mipil->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        <div class="mx-5 justify-content-center">
                                        ...
                                        <div class="col-lg-7 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="can-empty form-control @error ('nik') is-invalid @enderror"  id="nik" name="nik" placeholder="Masukkan NIK" value="{{ old('nik') }}" required>
                                    ...
                                    <div class="form-group">
                                        <div id="ayah_div">
                                            ...
                                            <select class="can-empty select2 custom-select @error ('ayah_kandung') is-invalid @enderror" name="ayah_kandung" id="ayah_kandung"  style="width: 100%" disabled>
                                                ...
                                                <option value="{{ $krama_mipil->cacah_krama_mipil->penduduk->id }}">{{ $krama_mipil->cacah_krama_mipil->penduduk->nama }}</option>
                                                @foreach($anggota_krama_mipil as $anggota)
                                                    <option value="{{ $anggota->cacah_krama_mipil->penduduk->id }}">{{ $anggota->cacah_krama_mipil->penduduk->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('ayah_kandung')
                                                <div class="invalid-feedback text-start">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    @if($krama_mipil->cacah_krama_mipil->penduduk->koordinat_alamat != NULL)
                                        @php 
                                    ...
                                    <div class="form-group" id="koordinat_pisah_div" style="display:none;">
                                        ...
                                        <div class="input-group mb-2 mr-sm-2">
                                            ...
                                            <div class="input-group-append">
                                                <button type="button" class="can-empty btn btn-primary" onclick="map_modal()" data-toggle="tooltip" data-placement="top" title="" data-original-title="Cari koordinat"><i class="fas fa-map-marker-alt"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    jQuery.ajax({
                        ...
                        success: function(result){
                            ...
                            if(result.status == 'ditemukan'){
                                ...
                                $('#provinsi_pisah').append('<option value="">Pilih Provinsi</option>');
