                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-12">
                                    <span class="text-dark font-weight-bold">: {{ substr($krama_mipil->nomor_krama_mipil,0,4) }}-{{ substr($krama_mipil->nomor_krama_mipil,4,2) }}-{{ substr($krama_mipil->nomor_krama_mipil,6,2) }}-{{ substr($krama_mipil->nomor_krama_mipil,8,4) }}-{{ substr($krama_mipil->nomor_krama_mipil,12,3) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-12">
                                    <span class="text-dark font-weight-bold">: {{ $krama_mipil->banjar_adat->nama_banjar_adat ?? '-' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-12">
                                    <span class="text-dark font-weight-bold">: {{ $krama_mipil->cacah_krama_mipil->tempekan->nama_tempekan ?? '-' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-12">
                                    <span class="text-dark font-weight-bold">: {{ date('d M Y', strtotime($krama_mipil->tanggal_registrasi)) ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
