                                ...
                                @foreach($riwayats as $riwayat)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a button type="button" class="btn btn-primary btn-sm"  data-toggle="tooltip" data-placement="top" title="" data-original-title="Detail" href="{{ route('banjar-krama-mipil-detail-riwayat', ['id'=>$krama_mipil->id,'id_riwayat'=>$riwayat->id]) }}"><i class="fas fa-eye"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
