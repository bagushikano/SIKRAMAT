        ...
        <div class="container mt-n15">
            <div class="card mb-4 mt-4">
                ...
                <div class="card-body">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{route('banjar-anggota-krama-mipil-update', $anggota_krama->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" id="pisah_tinggal" name="pisah_tinggal" @if($pisah_tinggal) checked @endif type="checkbox">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    ...
                                    <div class="form-group" id="koordinat_pisah_div" @if(!$pisah_tinggal) style="display:none;" @endif>
                                        <label for="koordinat" class="small">Koordinat Alamat</label>
                                        <div class="input-group mb-2 mr-sm-2">
                                            <input type="text" readonly class="form-control" name="koordinat_alamat_placeholder_pisah" id="koordinat_alamat_placeholder_pisah" placeholder="Pilih Koordinat" value="{{ old('koordinat_alamat_placeholder_pisah', $koor_placeholder) }}">
                                            <input type="text" hidden class="form-control" name="koordinat_alamat_pisah" id="koordinat_alamat_pisah" {{ old('koordinat_alamat_pisah', $penduduk->koordinat_alamat) }}>
                                            <div class="input-group-append">
