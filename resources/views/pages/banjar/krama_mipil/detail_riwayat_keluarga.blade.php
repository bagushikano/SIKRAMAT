...
@endpush
@section('title', 'Detail Perubahan Data Keluarga')
@section('content')
    <main>
                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            <h1 class="page-header-title">
                                <div class="page-header-icon"><i class="fas fa-history mr-2"></i></div>
                                Detail Riwayat Perubahan Data Keluarga
                            </h1>
                        ...
                        <div class="card-body h-100 d-flex justify-content-center py-5 py-xl-4">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <p class="text-gray-700 mb-0">Riwayat Perubahan Data Keluarga<br><span class="text-primary font-weight-bold">Krama Mipil</span>
                                    </p>
                                </div>
                ...
                <div class="col-xxl-8 col-xl-12">
                    <div class="card mb-4">
                        ...
                        <div class="card-body px-5 mt-2 mb-2">
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-3">
                                    <h5 for="title" class="font-weight-bold text-dark">Tanggal Perubahan</h5>
                                </div>
                                <div class="col-lg-8 col-sm-9">
                                    <span>: {{ date('d M Y', strtotime($krama_mipil->created_at)) }}</span>
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-lg-4 col-sm-3">
                                    <h5 for="title" class="font-weight-bold text-dark">Alasan Perubahan</h5>
                                </div>
                                <div class="col-lg-8 col-sm-9">
                                    <span>: {{ $krama_mipil->alasan_perubahan }}</span>
                                </div>
                            </div>

                            <hr class="my-4" />
                            <div class="float-left mb-n2">
                                <a class="btn btn-danger btn-icon-split my-1 text-end" href="{{ route('banjar-krama-mipil-riwayat-keluarga', $id) }}">
                                    <span class="icon">
