                    ...
                    <div class="row align-items-center justify-content-between">
                        <div class="col-auto mt-4">
                            <h1 class="page-header-title">
                                <div class="page-header-icon"><i class="fas fa-house-user mr-1"></i></div>
                                Dashboard Banjar Adat
                            </h1>
                            <div class="page-header-subtitle">
                                Dashboard Kependudukan Banjar Adat
                                <div class="d-none d-md-inline font-weight-700">
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1">
                                    ...
                                    <div class="h5">Jumlah: {{ $jumlah_perceraian }}</div>
                                    <div class="text-xs font-weight-bold text-success d-inline-flex align-items-center">
                                        <span class="mr-2">Bulan ini</span>
                                        <i class="mr-1" data-feather="trending-up"></i>
                                        + {{ $jumlah_perceraian_nambah }}
                                    </div>
                                </div>
