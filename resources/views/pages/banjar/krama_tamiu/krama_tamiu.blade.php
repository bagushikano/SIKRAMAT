        ...
        <div class="container mt-n10">
            ...
            <div class="card card-header-actions mb-4">
                <div class="card-header">
                    <div>
                        Krama Tamiu <span class="text-dark">Banjar Adat {{ Session::get('banjar_adat_nama') }}</span>
                    </div>
                    <button class="btn btn-sm btn-primary float-right" type="button" onclick="filter_modal()"><i class="fas fa-filter mr-2"></i>Filter Krama Tamiu</button>
                </div>
                <div class="card-body">
                    <a class="btn btn-primary btn-icon-split mb-3 text-end" href="{{ route('banjar-krama-tamiu-create') }}">
                        <span class="icon">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header bg-gray-100">
                    <h5 class="modal-title" id="exampleModalLabel">Filter Data Krama Tamiu</h5>
                ...
                <div class="modal-body mx-3">
                    <div class="row">
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="status" class="small">Status Krama Tamiu</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            <div class="form-group">
                                <label for="rentang_waktu_registrasi" class="small">Rentang Tanggal Registrasi</label>
            ...
            <div class="modal-content">
                <form id="form-delete-krama" method="post" action="#" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Keluarkan Krama Tamiu</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    </div>
...
@push('js')
    ...
    <script>
        function delete_krama(id){
            var url = "{{ route('banjar-krama-tamiu-delete', ":id") }}";
        ...
        $(document).ready( function () {
            ...
            $('#tanggal_registrasi').on('change', function(){
                if($(this).val()){
                    let tanggal_registrasi = $(this).val();
                    var url = "{{ route('banjar-krama-tamiu-generate-nomor-krama-tamiu', ":tanggal") }}";
                    url = url.replace(':tanggal', tanggal_registrasi);
                    jQuery.ajax({
                        url: url,
                        method: 'get',
        ...
        var TableDatatablesEditable = function () {
            var handleTable = function () {
                ...
                var oTable = table.DataTable({
                    ...
                    ajax: {
                        url : "{{ route('banjar-krama-tamiu-datatable') }}",
                        data : function(d){
                            d.status = $('#status').val();
                            d.asal = $('#asal').val();
