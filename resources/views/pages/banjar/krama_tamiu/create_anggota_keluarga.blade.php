        ...
        <div class="container mt-n15">
            <div class="card mb-4 mt-4">
                ...
                <div class="card-body">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{route('banjar-anggota-krama-tamiu-store', $krama_tamiu->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                                    ...
                                    <div class="form-group">
                                        <div id="ayah_div">
                                            ...
                                            <select class="can-empty select2 custom-select @error ('ayah_kandung') is-invalid @enderror" name="ayah_kandung" id="ayah_kandung"  style="width: 100%" disabled>
                                                ...
                                                <option value="{{ $krama_tamiu->cacah_krama_tamiu->penduduk->id }}">{{ $krama_tamiu->cacah_krama_tamiu->penduduk->nama }}</option>
                                                @foreach($anggota_krama_tamiu as $anggota)
                                                    <option value="{{ $anggota->cacah_krama_tamiu->penduduk->id }}">{{ $anggota->cacah_krama_tamiu->penduduk->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('ayah_kandung')
                                                <div class="invalid-feedback text-start">
...
@push('js')
    ...
    <script>
        ...
        var penduduk = {!! json_encode($krama_tamiu->cacah_krama_tamiu->penduduk) !!}
