            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('banjar-krama-tamiu-detail', $krama->id) }}" class="text-decoration-none">Krama Tamiu</a></li>
            ...
            <div class="card mb-4 mt-4">
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                ...
                                <div class="wizard-step-text-details text-dark">Detail Data Krama Tamiu</div>
                            </div>
                        </a>
                    </div>
                </div> 
                <div class="card-body">
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-12">
                                    <span class="text-dark font-weight-bold">: {{ substr($krama->nomor_krama_tamiu,0,4) }}-{{ substr($krama->nomor_krama_tamiu,4,2) }}-{{ substr($krama->nomor_krama_tamiu,6,2) }}-{{ substr($krama->nomor_krama_tamiu,8,4) }}-{{ substr($krama->nomor_krama_tamiu,12,3) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-12">
                                    <span class="text-dark font-weight-bold">: {{ $krama->cacah_krama_tamiu->banjar_dinas->nama_banjar_dinas ?? '-' }}</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-sm-12">
                                    <span class="text-dark font-weight-bold">: {{ $krama->cacah_krama_tamiu->alamat_asal ?? '-' }}</span>
                                </div>
                            </div>
                            ...
                            @elseif($krama->cacah_krama_tamiu->asal == 'dalam_bali')
                                <div class="row">
                                    <div class="col-lg-5 col-sm-12">
                    ...
                    <div class="float-left mx-5">
                        ...
                        @if($krama->status != '0')
                            <a class="btn btn-warning mr-2 btn-icon-split text-end" href="{{ route('banjar-krama-tamiu-edit', $krama->id) }}">
                                <span class="icon">
                        ...
                        @endif
                        <a class="btn btn-primary mr-2 btn-icon-split text-end" href="{{ route('banjar-krama-tamiu-daftar-riwayat', $krama->id) }}">
                            <span class="icon">
