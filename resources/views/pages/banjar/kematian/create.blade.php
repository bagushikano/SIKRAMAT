            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Tambah Kematian</li>
                    </ol>
                </div>
            </div>
        </header>
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                ...
                                <div class="wizard-step-text-details text-dark">Lengkapi Formulir Penambahan Data Kematian Berikut Ini</div>
                            </div>
                        </a>
                    </div>
                </div>
                            ...
                            <form id="form-create-kematian" method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control @error ('cacah_krama_mipil_placeholder') is-invalid @enderror form-custom"  id="cacah_krama_mipil_placeholder" name="cacah_krama_mipil_placeholder" placeholder="Pilih Cacah Krama Mipil" value="{{ old('cacah_krama_mipil_placeholder') }}" required>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('nomor_suket_kematian') is-invalid @enderror" id="nomor_suket_kematian" name="nomor_suket_kematian" type="text" value="{{ old('nomor_suket_kematian') }}" placeholder="Masukkan Nomor Surat Keterangan Kematian" required>
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control @error('nomor_akta_kematian') is-invalid @enderror" id="nomor_akta_kematian" name="nomor_akta_kematian" type="text" value="{{ old('nomor_akta_kematian') }}" placeholder="Masukkan Nomor Akta Kematian">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div>
                                        <button class="btn btn-success btn-icon-split text-end" onclick="simpan_kematian('0')">
                                            <span class="icon">
                                        ...
                                        <button class="btn btn-success btn-icon-split text-end" onclick="simpan_kematian('1')">
                                            <span class="icon">
                                                <i class="fas fa-save"></i>
                                            </span>
...
@push('js')
    ...
    <script>
        ...
        function simpan_kematian(status){
            var url = "{{ route('banjar-kematian-store', ":status") }}";
            url = url.replace(':status', status);
            $("#form-create-kematian").attr("action", url);
            $('#form-create-kematian').submit(function (e){
                e.stopPropagation();
            });
        }
    </script>
