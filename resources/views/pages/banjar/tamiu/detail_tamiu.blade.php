            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('banjar-cacah-tamiu-home') }}" class="text-decoration-none text-dark">Tamiu</a></li>
            ...
            <div class="card mb-4 mt-4">
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                ...
                                <div class="wizard-step-text-details text-dark">Detail Data Tamiu</div>
                            </div>
                        </a>
                    </div>
                </div>                 
                <div class="card-body">
                        ...
                        <div class="col-lg-9 col-sm-12">
                            <div class="row">
                                <div class="col-lg-5 col-sm-12">
                                    <label for="nomor_cacah_tamiu">Nomor Tamiu</label>
                                </div>
                                <div class="col-lg-7 col-sm-12">
                                    <span class="text-dark font-weight-bold">: {{ substr($tamiu->nomor_tamiu,0,4) }}-{{ substr($tamiu->nomor_tamiu,4,2) }}-{{ substr($tamiu->nomor_tamiu,6,2) }}-{{ substr($tamiu->nomor_tamiu,8,4) }}-{{ substr($tamiu->nomor_tamiu,12,3) }}</span>
                                </div>
                            </div>
                            ...
                            @if($krama->tanggal_keluar != NULL)
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-sm-12">
                                        <span class="text-dark font-weight-bold">: @if($krama->tanggal_keluar != NULL){{ date('d M Y', strtotime($krama->tanggal_keluar)) ?? '-' }}@else - @endif</span>
                                    </div>
                                </div>
                            @endif
                        </div>
                    ...
                    <div class="float-left mx-5">
                        ...
                        @if($krama->status != '0')
                            <a class="btn btn-warning mr-2 btn-icon-split text-end" href="{{ route('banjar-tamiu-edit', $tamiu->id) }}">
                                <span class="icon">
                        ...
                        @endif
                        <a class="btn btn-primary mr-2 btn-icon-split text-end" href="{{ route('banjar-tamiu-daftar-riwayat', $tamiu->id) }}">
                            <span class="icon">
