            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Edit Tamiu</li>
                    </ol>
                </div>
            </div>
        </header>
        ...
        <div class="container mt-n15">
            <div class="card mb-4 mt-4">
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                <div class="wizard-step-text-name text-dark">Data Tamiu</div>
                                <div class="wizard-step-text-details text-dark">Lengkapi Formulir Perubahan Data Tamiu Berikut Ini</div>
                            </div>
                        </a>
                    </div>
                </div>              
                ...
                <div class="card-body">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{ route('banjar-tamiu-update', $tamiu->id) }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        <div class="mx-5 justify-content-center">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-sm-12">
                                            <div class="form-group">
                                                <label for="title" class="small">Nomor Tamiu<span class="text-danger small">*</span></label>
                                                <input type="text" class="form-control @error ('nomor_tamiu') is-invalid @enderror"  id="nomor_tamiu" name="nomor_tamiu" placeholder="Masukkan Nomor Tamiu" value="{{ old('nomor_tamiu', $tamiu->nomor_tamiu) }}" required readonly>
                                                @error('nomor_tamiu')
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="can-empty select2 custom-select @error ('agama') is-invalid @enderror" name="agama" id="agama" style="width: 100%" required aria-placeholder="Pilih Agama" required>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    <div class="form-group">
                                        @if($tamiu->cacah_tamiu->penduduk->koordinat_alamat != NULL)
                                            @php 
                            ...
                            <div class="form-group" id="alamat_asal_row">
                                ...
                                <input type="text" class="can-empty form-control @error ('alamat_asal') is-invalid @enderror"  id="alamat_asal" name="alamat_asal" placeholder="Masukkan Alamat Asal" value="{{ old('alamat_asal', $cacah_tamiu->alamat_asal) }}" required>
                                @error('alamat_asal')
                                    <div class="invalid-feedback text-start">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="can-empty select2 custom-select @error ('kabupaten_asal') is-invalid @enderror" name="kabupaten_asal" id="kabupaten_asal"  style="width: 100%" required aria-placeholder="Pilih Kabupaten" required>
                                            ...
                                            @if(old('kabupaten_asal'))
                                                @foreach($kabupatens as $kabupaten)
                                                    <option value="{{ $kabupaten->id }}" @if(old('kabupaten_asal') == $kabupaten->id) selected @endif>{{ $kabupaten->name }}</option>
                                                @endforeach
                                            @else
                                                @foreach($kabupatens as $kabupaten)
                                ...
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <select class="can-empty select2 custom-select @error ('kecamatan_asal') is-invalid @enderror" name="kecamatan_asal" id="kecamatan_asal"  style="width: 100%" required aria-placeholder="Pilih Kecamatan" required>
                                            ...
                                            @if(old('kecamatan_asal'))
                                                @foreach($kecamatans as $kecamatan)
                                                    <option value="{{ $kecamatan->id }}" @if(old('kecamatan_asal') == $kecamatan->id) selected @endif>{{ $kecamatan->name }}</option>
                                                @endforeach
                                            @else
                                                @foreach($kecamatans as $kecamatan)
                            ...
                            <div class="row">
                                        ...
                                        <select class="can-empty select2 custom-select @error ('desa_asal') is-invalid @enderror" name="desa_asal" id="desa_asal"  style="width: 100%" required aria-placeholder="Pilih Desa" required>
                                            ...
                                            @if(old('desa_asal'))
                                                @foreach($desas as $desa)
                                                    <option value="{{ $desa->id }}" @if(old('desa_asal') == $desa->id) selected @endif>{{ $desa->name }}</option>
                                                @endforeach
                                            @else
                                                @foreach($desas as $desa)
                                ...
                                <div class="col-lg-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="can-empty datepicker-here form-control @error ('tanggal_masuk') is-invalid @enderror" placeholder="Masukkan Tanggal Registrasi" name="tanggal_registrasi" id="tanggal_registrasi" value="{{ old('tanggal_registrasi', date('d M Y', strtotime($tamiu->tanggal_registrasi))) }}" placeholder="Masukkan Tanggal Masuk Krama Mipil" required>
                                        @error('tanggal_masuk')
                                            <div class="invalid-feedback text-start">
                                                {{ $message }}
                                            </div>
        ...
        $(document).ready( function () {
            ...
            $('#search_button').on('click', function(){
                if($("#nik").val().length != 16){
                    ...
                    var url = "{{ route('banjar-tamiu-get-penduduk', ":nik") }}";
