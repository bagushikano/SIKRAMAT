        ...
        <div class="container mt-n15">
            <div class="card mb-4 mt-4">
                ...
                <div class="card-body">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{route('banjar-anggota-tamiu-update', $anggota_krama->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-5 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="can-empty form-control @error ('nomor_cacah_tamiu') is-invalid @enderror" id="nomor_cacah_tamiu" name="nomor_cacah_tamiu" placeholder="Masukkan Nomor Cacah Tamiu" value="{{ old('nomor_cacah_tamiu', $cacah_tamiu->nomor_cacah_tamiu) }}" readonly>
                                                @error('gelar_depan')
                                    ...
                                    <div class="form-group">
                                        <div id="ayah_div">
                                            ...
                                            <select class="can-empty select2 custom-select @error ('ayah_kandung') is-invalid @enderror" name="ayah_kandung" id="ayah_kandung"  style="width: 100%">
                                                ...
                                                <option value="{{ $tamiu->cacah_tamiu->penduduk->id }}" @if($penduduk->ayah_kandung_id == $tamiu->cacah_tamiu->penduduk->id) selected @endif>{{ $tamiu->cacah_tamiu->penduduk->nama }}</option>
                                                @foreach($anggota_tamiu as $anggota)
                                                    <option value="{{ $anggota->cacah_tamiu->penduduk->id }}" @if($penduduk->ayah_kandung_id == $anggota->cacah_tamiu->penduduk->id) selected @endif>{{ $anggota->cacah_tamiu->penduduk->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('ayah_kandung')
                                                <div class="invalid-feedback text-start">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input class="can-empty custom-control-input" id="cari_ayah_manual" type="checkbox">
                                    ...
                                    <div class="form-group" class="small">
                                        <div id="ibu_div">
                                            ...
                                            <select class="can-empty select2 custom-select @error ('ibu_kandung') is-invalid @enderror" name="ibu_kandung" id="ibu_kandung" style="width: 100%">
                                                ...
                                                <option value="{{ $tamiu->cacah_tamiu->penduduk->id }}" @if($penduduk->ibu_kandung_id == $tamiu->cacah_tamiu->penduduk->id) selected @endif>{{ $tamiu->cacah_tamiu->penduduk->nama }}</option>
                                                @foreach($anggota_tamiu as $anggota)
                                                    <option value="{{ $anggota->cacah_tamiu->penduduk->id }}" @if($penduduk->ibu_kandung_id == $anggota->cacah_tamiu->penduduk->id) selected @endif>{{ $anggota->cacah_tamiu->penduduk->nama }}</option>
                                                @endforeach
                                            </select>
                                            @error('ayah_kandung')
                                                <div class="invalid-feedback text-start">
                                        ...
                                        <div class="custom-control custom-checkbox">
                                            <input class="can-empty custom-control-input" id="cari_ibu_manual" type="checkbox">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select2 custom-select @error ('desa') is-invalid @enderror" name="desa" id="desa"  style="width: 100%" required aria-placeholder="Pilih Desa" required disabled>
                                            ...
                                            @foreach($desas as $des)
                                                <option value="{{ $des->id }}" @if($des->id == $tamiu->cacah_tamiu->penduduk->desa_id) selected @endif>{{ $des->name }}</option>
                                            @endforeach
                                        </select>
                                        @error('desa')
                                            <div class="invalid-feedback text-start">
