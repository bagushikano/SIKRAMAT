            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Tambah Tamiu</li>
                    </ol>
                </div>
            </div>
        </header>
        ...
        <div class="container mt-n15">
            <div class="card mb-4 mt-4">
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                ...
                                <div class="wizard-step-text-details text-dark">Lengkapi Formulir Penambahan Data Tamiu Berikut Ini</div>
                            </div>
                        </a>
                    </div>
                </div>              
                ...
                <div class="card-body">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{ route('banjar-tamiu-store') }}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        <div class="mx-5 justify-content-center">
                            ...
                            <div class="float-right">
                                <a class="btn btn-danger mr-2 btn-icon-split text-end" href="{{ route('banjar-tamiu-home') }}">
                                    <span class="icon">
