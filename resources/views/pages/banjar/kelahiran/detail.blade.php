    ...
    <div class="container mt-n15">
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-10 col-xl-10 mt-2">
                        ...
                        <div class="d-flex justify-content-between">
                            <a class="btn btn-danger btn-icon-split mb-3 text-end" href="{{ route('banjar-kelahiran-home') }}">
                                <span class="icon">
        ...
        {{-- <div class="card mb-4 mt-4">
            <div class="card-header border-bottom">
                <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                    <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                        <div class="wizard-step-icon"><i class="fas fa-users"></i></div>
                        <div class="wizard-step-text">
                            <div class="wizard-step-text-name text-dark">Data Keluarga</div>
                            <div class="wizard-step-text-details text-dark">Data Keluarga dari Anak yang Telah Lahir</div>
                        </div>
                    </a>
                </div>
            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-10 col-xl-10 mt-2">
                        <div class="row mt-3">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: XXXXXXXXX</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: I Wayan Darmawan Putra</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                                <label for="nomor_cacah_krama_mipil">Nomor Induk Cacah Krama Mipil</label>
                            </div>
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: 0325XXXXXXXX</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: 5106031306000001</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: Penida Kaja, 13 Jan 2022</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: Laki-laki</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: Hindu</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: Br. Penida Kaja, No 13 Bangli</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: Adat dan Dinas</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: Penida Kaja</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-3 col-sm-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-sm-12">
                                <span class="text-dark font-weight-bold">: <a class="text-start text-primary small" href="#" target="_blank"><i class="fas fa-download"></i> Unduh File Akta Kelahiran</a></span>
                            </div>
                        </div>
                    </div>
                </div>
