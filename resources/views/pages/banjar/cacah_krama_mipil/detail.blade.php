            ...
            <div class="card mb-4 mt-4">
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                ...
                                <div class="wizard-step-text-details text-dark">Detail Data Cacah Krama Mipil</div>
                            </div>
                        </a>
                    </div>
                </div>     
                <div class="card-body">
                    ...
                    <div class="float-left mx-5">
                        ...
                        @if($krama->status != '0')
                            <a class="btn btn-warning mr-2 btn-icon-split text-end" href="{{ route('banjar-cacah-krama-mipil-edit', $krama->id) }}">
                                <span class="icon">
                        ...
                        @endif
                        <a class="btn btn-primary mr-2 btn-icon-split text-end" href="{{ route('banjar-cacah-krama-mipil-daftar-riwayat', $krama->id) }}">
                            <span class="icon">
