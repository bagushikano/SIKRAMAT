...
@endpush
@section('title', 'Daftar Ajuan Data Kelahiran')
@section('content')
    <main>
            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Ajuan Data Kelahiran</li>
                    </ol>
                </div>
            </div>
        </header>
        ...
        <div class="container mt-n10">
            ...
            <div class="card card-header-actions mb-4">
                <div class="card-header">
                    <div>
                        Ajuan Data Kelahiran <span class="text-dark">Banjar Adat {{ Session::get('banjar_adat_nama') }}</span>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header bg-gray-100">
                    <h5 class="modal-title" id="exampleModalLabel">Filter Data Ajuan Kelahiran</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        <label for="status" class="small" class="text-dark">Status Ajuan Data Kelahiran</label>
        ...
        var TableDatatablesEditable = function () {
            var handleTable = function () {
                ...
                var oTable = table.DataTable({
                    ...
                    ajax: {
                        url : "{{ route('banjar-ajuan-kelahiran-datatable') }}",
                        data : function(d){
                            d.status = $('#status').val();
