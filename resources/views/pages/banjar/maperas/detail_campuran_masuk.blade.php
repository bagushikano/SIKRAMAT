                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    ...
                                    @if($maperas->file_sudhi_wadhani != NULL)
                                        <div class="row">
                                            <div class="col-lg-5 col-sm-4">
                                                <label for="nomor_cacah_krama_mipil">Bukti Upacara Sudhi Wadhani</label>
                                            </div>
                                            <div class="col-lg-7 col-sm-8">
                                                <span>: @if($maperas->file_sudhi_wadhani != NULL)<a class="text-start text-primary" href="{{ $maperas->file_sudhi_wadhani }}" target="_blank"><i class="fas fa-download"></i> Unduh File Bukti Upacara Sudhi Wadhani</a>@endif</span>
                                            </div>
                                        </div>
                                    @endif
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-sm-8">
                                            <span class="text-dark font-weight-bold">: {{ $maperas->nik_ayah_lama }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-5 col-sm-4">
                                        ...
                                        <div class="col-lg-7 col-sm-8">
                                            <span class="text-dark font-weight-bold">: {{ $maperas->nama_ayah_lama }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-5 col-sm-4">
                                        ...
                                        <div class="col-lg-7 col-sm-8">
                                            <span class="text-dark font-weight-bold">: {{ $maperas->nik_ibu_lama }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-5 col-sm-4">
                                        ...
                                        <div class="col-lg-7 col-sm-8">
                                            <span class="text-dark font-weight-bold">:  {{ $maperas->nama_ibu_lama }}</span>
                                        </div>
                                    </div>
                                    @if($maperas->nama_ayah_lama != NULL && $maperas->nama_ibu_lama != NULL)
                                        <div class="row">
                                            <div class="col-lg-5 col-sm-4">
