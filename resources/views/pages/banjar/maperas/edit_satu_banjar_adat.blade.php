                            ...
                            <form id="form-edit-maperas" method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div id="perkawinan_dalam_desa_adat">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" class="form-control @error ('keterangan') is-invalid @enderror" placeholder="Masukkan Keterangan (Jika Ada)" rows="3" name="keterangan" id="keterangan">{{ $maperas->keterangan }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-success btn-icon-split text-end" onclick="simpan_maperas({{ $maperas->id }},'1')">
                                            <span class="icon">
                                                <i class="fas fa-save"></i>
                                            </span>
...
@push('js')
    ...
    <script>
        ...
        function simpan_maperas(id, status){
            var url = "{{ route('banjar-maperas-satu-banjar-adat-update', [":id", ":status"]) }}";
