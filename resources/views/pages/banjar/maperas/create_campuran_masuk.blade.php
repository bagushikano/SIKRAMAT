...
@push('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#btn-next-1").on('click', function() {
                ...
                $('#wizard1 input.form-control').each(function () {
                    ...
                    if($("#nik_ayah").val().length != 16 && $('#nik_ayah').val() != ''){
                        $("#nik-validate-ayah").show();
                        $('#nik_ayah').removeClass("is-valid");
                        $('#nik_ayah').addClass("is-invalid");
                        isValid = false;
                    }
                    if($("#nik_ibu").val().length != 16 && $('#nik_ibu').val() != ''){
                        $("#nik-validate-ibu").show();
                        $('#nik_ibu').removeClass("is-valid");
        ...
        function simpan_maperas(status){
            var url = "{{ route('banjar-maperas-campuran-masuk-store', ":status") }}";
