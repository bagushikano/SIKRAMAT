                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-12 py-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nik_ayah') is-invalid @enderror"  id="nik_ayah" name="nik_ayah" placeholder="Masukkan NIK Ayah Baru" value="{{ old('nik_ayah', $maperas->nik_ayah_baru) }}" required>
                                                @error('nik_ayah')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-lg-8 col-sm-12 py-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nama_ayah') is-invalid @enderror" id="nama_ayah" name="nama_ayah" placeholder="Masukkan Nama Ayah Baru" value="{{ old('nama_ayah', $maperas->nama_ayah_baru) }}" required>
                                                @error('nama_ayah')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-12 py-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nik_ibu') is-invalid @enderror"  id="nik_ibu" name="nik_ibu" placeholder="Masukkan NIK Ibu Baru" value="{{ old('nik_ibu', $maperas->nik_ibu_baru) }}" required>
                                                @error('nik_ibu')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                        ...
                                        <div class="col-lg-8 col-sm-12 py-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nama_ibu') is-invalid @enderror" id="nama_ibu" name="nama_ibu" placeholder="Masukkan Nama Ibu Baru" value="{{ old('nama_ibu', $maperas->nama_ibu_baru) }}" required>
                                                @error('nama_ibu')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-12 py-2">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 custom-select @error ('agama') is-invalid @enderror" name="agama" id="agama" style="width: 100%" required aria-placeholder="Pilih Agama" required>
                                                    ...
                                                    @else
                                                        <option value="islam" @if($maperas->agama_baru == 'islam') selected @endif>Islam</option>
                                                        <option value="protestan" @if($maperas->agama_baru == 'protestan') selected @endif>Protestan</option>
                                                        <option value="katolik" @if($maperas->agama_baru == 'katolik') selected @endif>Katolik</option>
                                                        <option value="hindu" @if($maperas->agama_baru == 'hindu') selected @endif>Hindu</option>
                                                        <option value="buddha" @if($maperas->agama_baru == 'buddha') selected @endif>Buddha</option>
                                                        <option value="khonghucu" @if($maperas->agama_baru == 'khonghucu') selected @endif>Khonghucu</option>
                                                    @endif
                                                </select>
                                                @error('agama')
                                                    <div class="invalid-feedback text-start">
                                        ...
                                        <div class="col-lg-8 col-sm-12 py-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('alamat') is-invalid @enderror" placeholder="Masukkan Alamat Asal" name="alamat" id="alamat" value="{{ old('alamat', $maperas->alamat_asal) }}" required>
                                            </div>
                                        </div>
                                    </div>   
                                        ...
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            ...
                                            <select class="select2 custom-select @error ('provinsi_asal') is-invalid @enderror" name="provinsi_asal" id="provinsi_asal"  style="width: 100%" required aria-placeholder="Pilih Provinsi" required>
                                                ...
                                                @foreach($provinsis as $provinsi)
                                                    <option value="{{ $provinsi->id }}" @if($provinsi->id == $provinsi_asal->id) selected @endif>{{ $provinsi->name }}</option>
                                                @endforeach
                                            </select>
                                            @error('provinsi_asal')
                                                <div class="invalid-feedback text-start">
                                        ...
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            ...
                                            <select class="select2 custom-select @error ('kabupaten_asal') is-invalid @enderror" name="kabupaten_asal" id="kabupaten_asal"  style="width: 100%" required aria-placeholder="Pilih Kabupaten" required>
                                                ...
                                                @foreach($kabupaten_asals as $kabupaten)
                                                    <option value="{{ $kabupaten->id }}" @if($kabupaten->id == $kabupaten_asal->id) selected @endif>{{ $kabupaten->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            ...
                                            <select class="select2 custom-select @error ('kecamatan_asal') is-invalid @enderror" name="kecamatan_asal" id="kecamatan_asal"  style="width: 100%" required aria-placeholder="Pilih Kecamatan" required>
                                                ...
                                                @foreach($kecamatan_asals as $kecamatan)
                                                    <option value="{{ $kecamatan->id }}" @if($kecamatan->id == $kecamatan_asal->id) selected @endif>{{ $kecamatan->name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            ...
                                            <select class="select2 custom-select @error ('desa_asal') is-invalid @enderror" name="desa_asal" id="desa_asal"  style="width: 100%" required aria-placeholder="Pilih Desa" required>
                                                ...
                                                @foreach($desa_asals as $desa)
                                                    <option value="{{ $desa->id }}" @if($desa->id == $desa_asal->id) selected @endif>{{ $desa->name }}</option>
                                                @endforeach
                                            </select>
...
@push('js')
    ...
    <script>
        ...
        function simpan_maperas(id, status){
            var url = "{{ route('banjar-maperas-campuran-keluar-update', [":id", ":status"]) }}";
