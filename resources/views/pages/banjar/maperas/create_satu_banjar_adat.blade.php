                            ...
                            <form id="form-create-maperas" method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div id="perkawinan_dalam_desa_adat">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  id="jenis_maperas" name="jenis_maperas" value="Maperas Satu Banjar Adat" required readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error ('krama_mipil_baru_placeholder') is-invalid @enderror form-custom"  id="krama_mipil_baru_placeholder" name="krama_mipil_baru_placeholder" placeholder="Pilih Krama Mipil Baru" value="{{ old('krama_mipil_baru_placeholder') }}" required readonly>
                                            <div class="input-group-append">
                                        ...
                                        <input type="text" class="form-control @error ('krama_mipil_baru') is-invalid @enderror"  id="krama_mipil_baru" name="krama_mipil_baru"  value="{{ old('krama_mipil_baru') }}" required hidden>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nama_pemuput') is-invalid @enderror"  id="nama_pemuput" name="nama_pemuput" placeholder="Masukkan Nama Pemuput Maperas" value="{{ old('nama_pemuput') }}" required>
                                                @error('nama_pemuput')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id="validasi-file_bukti_maperas" class="text-danger small mt-2 text-end" style="display:none;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div id="validasi-file_akta_pengangkatan_anak" class="text-danger small mt-2 text-end" style="display:none;">
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div>
                                        ...
                                        <button class="btn btn-success btn-icon-split text-end" onclick="simpan_maperas('1')">
                                            <span class="icon">
                                                <i class="fas fa-save"></i>
                                            </span>
...
@push('js')
    ...
    <script>
            ...
            var handleTable = function () {
                ...
                var oTable_krama_mipil_lama = table_krama_mipil_lama.DataTable({
                    ...
                    ajax: {
                        ...
                        data : function(d){
                            d.krama_mipil_baru_id = $('#krama_mipil_baru').val();
                        }
                    },
                    columns: [
                ...
                var oTable_krama_mipil_baru = table_krama_mipil_baru.DataTable({
                    ...
                    ajax: {
                        ...
                        data : function(d){
                            d.krama_mipil_lama_id = $('#krama_mipil_lama').val();
                        }
                    },
                    columns: [
                        { data: "DT_RowIndex", class:"text-center", orderable: false, searchable: false, name: 'DT_RowIndex' },
        ...
        function simpan_maperas(status){
            var url = "{{ route('banjar-maperas-satu-banjar-adat-store', ":status") }}";
