...
@section('content')
                            ...
                            <form id="form-edit-perkawinan" method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div id="perkawinan_dalam_desa_adat">
                                    <div class="form-group">
                                        <label for="title" class="small">Jenis Perkawinan</label>
                                        <input type="text" class="form-control"  id="jenis_perkawinan" name="jenis_perkawinan" value="Perkawinan Satu Banjar Adat" required readonly>
                                    </div>

                                    <div class="form-group">
                                        <label for="title" class="small">Pilih Mempelai Purusa<span class="text-danger small">*</span></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control @error ('purusa_placeholder') is-invalid @enderror form-custom"  id="purusa_placeholder" name="purusa_placeholder" placeholder="Pilih Mempelai Purusa" value="{{ old('purusa_placeholder', $perkawinan->purusa->penduduk->nama) }}" required readonly>
                                        ...
                                        <input type="text" class="form-control @error ('purusa') is-invalid @enderror"  id="purusa" name="purusa"  value="{{ old('purusa', $perkawinan->purusa_id) }}" required hidden>
                                        @error('purusa')
                                        ...
                                        @else
                                            <div class="invalid-feedback">
                                                Mempelai Purusa wajib dipilih
                                            </div>
                                        @enderror
                                    </div>

                                    <div class="form-group">
                                        <label for="title" class="small">Pilih Mempelai Pradana<span class="text-danger small">*</span></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control @error ('pradana_placeholder') is-invalid @enderror form-custom"  id="pradana_placeholder" name="pradana_placeholder" placeholder="Pilih Mempelai Pradana" value="{{ old('pradana_placeholder', $perkawinan->pradana->penduduk->nama) }}" required readonly>
                                            <div class="input-group-append">
                                        ...
                                        @else
                                            <div class="invalid-feedback">
                                                Mempelai Pradana wajib dipilih
                                            </div>
                                        @enderror
                                    </div>
    ...
    <div class="modal fade" id="select_pradana_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-krama" role="document">
            <div class="modal-content">
                <div class="modal-header bg-gray-100">
                    <h5 class="modal-title" id="pilih_cacah_title">Pilih Pradana</h5>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                </div>
                <div class="modal-body">
                    <div class="datatable">
...
@push('js')
    ...
    <script>
        ...
        function simpan_perkawinan(id, status){
            var url = "{{ route('banjar-perkawinan-satu-banjar-adat-update', [":id", ":status"]) }}";
