                        ...
                        <div class="card-body px-5 mt-2">
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-9">
                                        <span>: Campuran Masuk Banjar Adat</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-9">
                                    <span>: @if($perkawinan->file_bukti_serah_terima_perkawinan != NULL)<a class="text-start text-primary" href="{{ $perkawinan->file_bukti_serah_terima_perkawinan }}" target="_blank"><i class="fas fa-download"></i> Unduh File Bukti Serah Terima Perkawinan</a>@endif</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-9">
                                    <span>: @if($perkawinan->file_akta_perkawinan != NULL)<a class="text-start text-primary" href="{{ $perkawinan->file_akta_perkawinan }}" target="_blank"><i class="fas fa-download"></i> Unduh File Akta Perkawinan</a>@endif</span>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-sm-12">
                                            <span class="text-dark font-weight-bold">: {{ $perkawinan->alamat_asal_pradana ?? '-' }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-7 col-sm-12">
                                            <span class="text-dark font-weight-bold">: {{ $perkawinan->nama_ayah_pradana ?? '-' }}</span>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-5 col-sm-12">
                                        ...
                                        <div class="col-lg-7 col-sm-12">
                                            <span class="text-dark font-weight-bold">: {{ $perkawinan->nama_ibu_pradana ?? '-' }}</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4 col-sm-12">
