            ...
            <div class="container">
                <div class="page-header-content pt-4">
                    ...
                    <ol class="breadcrumb mb-0 mt-4">
                        ...
                        <li class="breadcrumb-item active text-red-pastel">Detail Perkawinan Keluar Banjar</li>
                    </ol>
                </div>
            </div>
        </header>
            ...
            <div class="row">
                ...
                <div class="col-xxl-8 col-xl-12 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body px-5 mt-3 mb-2">
                            <div class="row">
                            ...
                            <a class="btn btn-success btn-icon-split my-1 mx-1 text-end" href="{{ route('banjar-perkawinan-keluar-konfirmasi', $perkawinan->id) }}">
                                <span class="icon">
