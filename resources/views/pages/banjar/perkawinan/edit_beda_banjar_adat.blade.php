...
@section('content')
                    ...
                    <div class="nav nav-pills nav-justified flex-column flex-xl-row nav-wizard" id="cardTab" role="tablist">
                        <a class="nav-item nav-link active bg-gray-200" id="wizard1-tab" href="#wizard1" data-toggle="tab" role="tab" aria-controls="wizard1" aria-selected="true">
                            ...
                            <div class="wizard-step-text">
                                ...
                                <div class="wizard-step-text-details text-dark">Lengkapi Formulir Edit Perkawinan Berikut Ini</div>
                            </div>
                        </a>
                    </div>
                </div>
                            ...
                            <form id="form-edit-perkawinan" method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div id="perkawinan_dalam_desa_adat">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error ('purusa_placeholder') is-invalid @enderror form-custom"  id="purusa_placeholder" name="purusa_placeholder" placeholder="Pilih Mempelai Purusa" value="{{ $perkawinan->purusa->penduduk->nama }}" required readonly>
                                        ...
                                        <input type="text" class="form-control @error ('purusa') is-invalid @enderror"  id="purusa" name="purusa"  value="{{ $perkawinan->purusa_id }}" required hidden>
                                        @error('purusa')
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group mb-n1">
                                                ...
                                                <select class="select2 custom-select @error ('desa_adat_pradana') is-invalid @enderror" name="desa_adat_pradana" id="desa_adat_pradana"  style="width: 100%" required>
                                                    ...
                                                    @foreach($desa_adats as $desa_adat)
                                                        <option value="{{ $desa_adat->id }}" @if($desa_adat->id == $perkawinan->desa_adat_pradana_id) selected @endif>{{ $desa_adat->desadat_nama }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="form-group mb-n1">
                                                ...
                                                <select class="select2 custom-select @error ('banjar_adat_pradana') is-invalid @enderror" name="banjar_adat_pradana" id="banjar_adat_pradana"  style="width: 100%" required>
                                                    ...
                                                    @foreach($banjar_adats as $banjar_adat)
                                                        <option value="{{ $banjar_adat->id }}" @if($banjar_adat->id == $perkawinan->banjar_adat_pradana_id) selected @endif>{{ $banjar_adat->nama_banjar_adat }}</option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error ('pradana_placeholder') is-invalid @enderror form-custom"  id="pradana_placeholder" name="pradana_placeholder" placeholder="Pilih Mempelai Pradana" value="{{ $perkawinan->pradana->penduduk->nama }}" required readonly>
                                            <div class="input-group-append">
                                        ...
                                        <input type="text" class="form-control @error ('pradana') is-invalid @enderror"  id="pradana" name="pradana"  value="{{ $perkawinan->pradana_id }}" required hidden>
                                        @error('pradana')
                                            <div class="invalid-feedback d-block">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="d-flex justify-content-between mb-2">
                                    ...
                                    <div>
                                        ...
                                        {{-- <button class="btn btn-success btn-icon-split text-end" onclick="simpan_perkawinan({{ $perkawinan->id }},'1')">
                                            <span class="icon">
                                                <i class="fas fa-save"></i>
                                            </span>
    ...
    {{-- HIDDEN FORM --}}
    <input type="text" class="form-control"  id="current_pradana_id" name="current_pradana_id"  value="{{ old('purusa', $perkawinan->pradana_id) }}" hidden>
    {{-- HIDDEN FORM --}}
@endsection
...
@push('js')
    ...
    <script>
                ...
                var oTable_pradana = table_pradana.DataTable({
                    ...
                    ajax: {
                        ...
                        data : function(d){
                            ...
                            d.purusa = $('#purusa').val();
                            d.current_pradana_id = $('#current_pradana_id').val(); 
                        }
                    },
                    columns: [
                        { data: "DT_RowIndex", class:"text-center", orderable: false, searchable: false, name: 'DT_RowIndex' },
        ...
        function simpan_perkawinan(id, status){
            var url = "{{ route('banjar-perkawinan-beda-banjar-adat-update', [":id", ":status"]) }}";
