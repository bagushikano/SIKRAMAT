                                ...
                                <div id="perkawinan_dalam_desa_adat">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control @error ('pradana_placeholder') is-invalid @enderror form-custom"  id="pradana_placeholder" name="pradana_placeholder" placeholder="Pilih Cacah Krama" value="" required readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error ('nama_pasangan') is-invalid @enderror" placeholder="Masukkan Nama Pasangan" name="nama_pasangan" id="nama_pasangan" value="{{ old('nama_pasangan') }}" required>
                                        @error('nama_pasangan')
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control @error ('nik_pasangan') is-invalid @enderror" placeholder="Masukkan NIK Pasangan" name="nik_pasangan" id="nik_pasangan" value="{{ old('nik_pasangan') }}" required>
                                                @error('nik_pasangan')
                                                    <div class="invalid-feedback text-start">
                                                        {{ $message }}
                                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Masukkan Alamat Asal Pasangan" name="alamat_pasangan" id="alamat_pasangan" value="{{ old('alamat_pasangan') }}">
                                    </div>

                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            <label class="small" for="title">Provinsi Asal Pasangan</label>
                                            <select class="select2 custom-select @error ('provinsi_asal') is-invalid @enderror" name="provinsi_asal" id="provinsi_asal"  style="width: 100%" aria-placeholder="Pilih Provinsi">
                                        ...
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            ...
                                            <select class="select2 custom-select @error ('kabupaten_asal') is-invalid @enderror" name="kabupaten_asal" id="kabupaten_asal"  style="width: 100%" aria-placeholder="Pilih Kabupaten">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            ...
                                            <select class="select2 custom-select @error ('kecamatan_asal') is-invalid @enderror" name="kecamatan_asal" id="kecamatan_asal"  style="width: 100%" aria-placeholder="Pilih Kecamatan">
                                        ...
                                        <div class="col-lg-6 col-sm-12 py-2">
                                            ...
                                            <select class="select2 custom-select @error ('desa_asal') is-invalid @enderror" name="desa_asal" id="desa_asal"  style="width: 100%" aria-placeholder="Pilih Desa">
...
@push('js')
    ...
    <script>
        ...
        function simpan_perkawinan(status){
            var url = "{{ route('banjar-perkawinan-campuran-keluar-store', ":status") }}";
