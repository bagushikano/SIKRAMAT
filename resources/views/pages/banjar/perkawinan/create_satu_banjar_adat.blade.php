                        ...
                        <div class="col-xxl-9 col-xl-10 mt-4">
                            <form id="form-create-perkawinan" method="post" action="" enctype="multipart/form-data" class="needs-validation" novalidate>
                                ...
                                <div id="perkawinan_dalam_desa_adat">
                                    ...
                                    <div class="form-group">
                                        <label for="title" class="small">Mempelai Purusa<span class="text-danger small">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="title" class="small">Mempelai Pradana<span class="text-danger small">*</span></label>
                                        <div class="input-group">
...
@push('js')
    ...
    <script>
        ...
        function simpan_perkawinan(status){
            var url = "{{ route('banjar-perkawinan-satu-banjar-adat-store', ":status") }}";
