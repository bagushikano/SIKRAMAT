                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 col-sm-9">
                                    @if($perkawinan->jenis_perkawinan == 'satu_banjar_adat')
                                        <span>: Satu Banjar Adat</span>
                                    @elseif($perkawinan->jenis_perkawinan == 'beda_banjar_adat')
                                        @if($perkawinan->banjar_adat_purusa_id == session()->get('banjar_adat_id'))
                                            <span>: Beda Banjar Adat (Masuk Banjar Adat)</span>
                                        @elseif($perkawinan->banjar_adat_pradana_id == session()->get('banjar_adat_id'))
                                            <span>: Beda Banjar Adat (Keluar Banjar Adat)</span>
                                        @endif
                                    @elseif($perkawinan->jenis_perkawinan == 'campuran_masuk')
                                        <span>: Campuran Masuk Banjar Adat</span>
                                    @elseif($perkawinan->jenis_perkawinan == 'campuran_keluar')
                        ...
                        <div class="col-xxl-10 col-xl-8">
                            ...
                            <div class="row">
                                <div class="col-lg-8 col-sm-12">
                                    ...
                                    @elseif($perkawinan->banjar_adat_purusa_id == session()->get('banjar_adat_id'))
                                        <div class="row">
                                            <div class="col-lg-5 col-sm-12">
                                                <label for="nomor_cacah_krama_mipil">Desa Adat</label>
                                            </div>
