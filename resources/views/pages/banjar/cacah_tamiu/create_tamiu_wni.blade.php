...
@section('content')
        ...
        <div class="container mt-n15">
            <div class="card mb-4 mt-4">
                ...
                <div class="card-body">
                    ...
                    <form id="form-create-krama-mipil" method="post" action="{{route('banjar-cacah-tamiu-wni-store')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error ('nomor_tamiu') is-invalid @enderror" id="nomor_tamiu" name="nomor_tamiu" placeholder="Nomor Tamiu" value="" readonly>
                                    </div>
                                </div>
                                <div class="col-lg-8 col-sm-12">
                                    <div class="form-group">
                                        <label for="title" class="small">Tamiu<span class="text-danger small">*</span></label>
                                        <div class="input-group">
                                            <input type="text" class="form-control @error ('tamiu_placeholder') is-invalid @enderror"  id="tamiu_placeholder" name="tamiu_placeholder" placeholder="Pilih Tamiu" value="{{ old('tamiu_placeholder') }}" required>
                                            <div class="input-group-append">
                                                <button class="btn btn-primary btn-icon-split" type="button" onclick="pilih_tamiu_modal()">
                                                    <span class="text">Pilih Tamiu</span>
                                                    <span class="icon">
                                        ...
                                        <input type="text" class="form-control @error ('tamiu') is-invalid @enderror"  id="tamiu" name="tamiu"  value="{{ old('tamiu') }}" required hidden>
                                        @error('tamiu')
    ...
    <div class="modal fade" id="select_tamiu_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            @csrf
                <div class="modal-content">
                    <div class="modal-header bg-gray-100">
                        <h5 class="modal-title" id="exampleModalLabel">Pilih Tamiu (Kepala Keluarga)</h5>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                    </div>
                    <div class="modal-body">
                        <div class="datatable">
                            <table class="table table-bordered table-hover" id="dataTable-tamiu" width="100%" cellspacing="0">
                                <thead>
                                    <tr>
                                        <th style="width: 5%">No.</th>
                                        <th style="width: 15%">No. Tamiu</th>
                                        <th>Nama</th>
    ...
    <script>
        $(document).ready( function () {
            ...
            $('#search_button').on('click', function(){
                if($('#tamiu').val()){
                    ...
                    Toast.fire({
                        icon: 'warning',
                        title: 'Pilih Tamiu terlebih dahulu'
                    })
                }
        ...
        function format ( d ) {
            ...
            if(d.anggota_keluarga){
                d.anggota_keluarga.forEach(function (value, i) {
                    ...
                    var nama = '';
                    if(value.cacah_tamiu.penduduk.gelar_depan){
                        nama = nama + value.cacah_tamiu.penduduk.gelar_depan; 
                    }
                    nama = nama + ' ' + value.cacah_tamiu.penduduk.nama;
                    if(value.cacah_tamiu.penduduk.gelar_belakang){
                        nama = nama + ', ' + value.cacah_tamiu.penduduk.gelar_belakang;
                    }
        ...
        var TableDatatablesEditable = function () {
            var handleTable = function () {
                ...
                $('#dataTable-tamiu tbody').on('click', 'td.dt-control', function () {
        ...
        function pilih_tamiu_modal(){
            $('#select_tamiu_modal').on('show.bs.modal', function(e) {
                //filter();
            }).modal('show');
        }

        function pilih_tamiu(id, nama){
            $('#tamiu').val(id);
            $('#tamiu_placeholder').val(nama);
            $('#tamiu_placeholder').prop('readonly', true);
            $('#select_tamiu_modal').modal('hide');
            Toast.fire({
                icon: 'success',
                title: 'Tamiu Berhasil Dipilih'
            })
            var url = "{{ route('banjar-cacah-tamiu-get-anggota-keluarga', ":id") }}";
            ...
            jQuery.ajax({
                ...
                success: function(result){
                    ...
                    $('#nomor_tamiu').val(result.tamiu.nomor_tamiu);
                    ...
                    $('#ayah_kandung').append('<option value="'+result.tamiu.cacah_tamiu.penduduk.id+'">'+result.tamiu.cacah_tamiu.penduduk.nama+'</option>');
                    $('#ibu_kandung').append('<option value="'+result.tamiu.cacah_tamiu.penduduk.id+'">'+result.tamiu.cacah_tamiu.penduduk.nama+'</option>');
                    result.anggota_tamiu.forEach(element => {
                        $('#ayah_kandung').append('<option value="'+element.cacah_tamiu.penduduk.id+'">'+element.cacah_tamiu.penduduk.nama+'</option>');
                        $('#ibu_kandung').append('<option value="'+element.cacah_tamiu.penduduk.id+'">'+element.cacah_tamiu.penduduk.nama+'</option>');
                    });

                    //ASSIGN ALAMAT
                    console.log(result.tamiu.cacah_tamiu.penduduk);
                    $('#alamat').val(result.tamiu.cacah_tamiu.penduduk.alamat);
                    $('#desa').val(result.tamiu.cacah_tamiu.penduduk.desa_id).trigger('change');
                    $('#banjar_dinas_id').val(result.tamiu.cacah_tamiu.banjar_dinas_id).trigger('change');

                    let koor = JSON.parse(result.tamiu.cacah_tamiu.penduduk.koordinat_alamat);
