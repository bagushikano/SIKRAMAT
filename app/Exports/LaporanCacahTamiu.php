...
class LaporanCacahTamiu implements FromView, WithStyles, ShouldAutoSize, WithEvents, WithColumnWidths, WithColumnFormatting
{
    protected $tamiu;
    ...
    public function view(): View
    {
        ...
        if ($this->request->banjar_adat_tamu) {
            return view("vendor.export.excel.desa_adat.laporan-cacah-tamiu", compact('data'));
        } else {
            return view("vendor.export.excel.banjar_adat.laporan-cacah-tamiu", compact('data'));
        }
