...
class LaporanKramaMipil implements FromView, WithStyles, ShouldAutoSize, WithEvents, WithColumnWidths, WithColumnFormatting
{
    ...
    public function view(): View
    {
        ...
        if ($this->request->banjar_adat_mipil) {
            return view("vendor.export.excel.desa_adat.laporan-krama-mipil", compact('data'));
        } else{
            return view("vendor.export.excel.banjar_adat.laporan-krama-mipil", compact('data'));
        }
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                $event->sheet->getDelegate()->getStyle('A:P')->getFont()->setSize(12);
                $event->sheet->getDelegate()->getStyle('A:P')->getAlignment()->setWrapText(true);
                $event->sheet->getDelegate()->getStyle('A:P')->getFont()->setName("Times New Roman");
