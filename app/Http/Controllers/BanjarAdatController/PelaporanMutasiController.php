...
class PelaporanMutasiController extends Controller
{
    ...
    {        
        return view('pages.banjar.pelaporan.mutasi.index');
    }
    ...
    public function lapKelahiran(Request $request)
    {
        ...
        return view('pages.banjar.pelaporan.mutasi.laporan-kelahiran', compact('data'));
    }
    ...
    public function lapKematian(Request $request)
    {
        ...
        return view('pages.banjar.pelaporan.mutasi.laporan-kematian', compact('data'));
    }
    ...
    public function lapPerkawinan(Request $request)
    {
        ...
        return view('pages.banjar.pelaporan.mutasi.laporan-perkawinan', compact('data'));
    }
    ...
    public function lapPerceraian(Request $request)
    {
        ...
        return view('pages.banjar.pelaporan.mutasi.laporan-perceraian', compact('data'));
    }
    ...
    public function lapMaperas(Request $request)
    {
        ...
        return view('pages.banjar.pelaporan.mutasi.laporan-maperas', compact('data'));
    }
}