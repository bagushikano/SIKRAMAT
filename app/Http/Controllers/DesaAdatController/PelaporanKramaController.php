...
class PelaporanKramaController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'banjar_dinas' => $this->serviceBanjarDinas->findByDesaAdatId($desadat_id),
        ];

        return view('pages.desa.pelaporan.krama.index', compact('data'));
    }
    ...
    public function lapKramaMipil(Request $request)
    {
        ...
        if ($request->banjar_adat_mipil) {
            ...
            $grafik_banjar_adat_laki = $this->serviceKramaMipil->getGrafikBanjarAdat($desadat_id, $request, 'laki-laki');
            $grafik_banjar_adat_perempuan = $this->serviceKramaMipil->getGrafikBanjarAdat($desadat_id, $request, 'perempuan');
        }
        ...
        $grafik_profesi_laki = $this->serviceKramaMipil->getGrafikProfesi($desadat_id, $request, 'laki-laki');
        $grafik_profesi_perempuan = $this->serviceKramaMipil->getGrafikProfesi($desadat_id, $request, 'perempuan');
        ...
        $grafik_pendidikan_laki = $this->serviceKramaMipil->getGrafikPendidikan($desadat_id, $request, 'laki-laki');
        $grafik_pendidikan_perempuan = $this->serviceKramaMipil->getGrafikPendidikan($desadat_id, $request, 'perempuan');

        # Get Grafik Golongan Darah
        foreach ($request->goldar_mipil as $data) {
            $goldar[] = 'Golongan Darah '.$data;
        }
        $grafik_goldar_laki = $this->serviceKramaMipil->getGrafikGoldar($desadat_id, $request, 'laki-laki');
        $grafik_goldar_perempuan = $this->serviceKramaMipil->getGrafikGoldar($desadat_id, $request, 'perempuan');

        # Get All Krama Data
        $krama_mipil = $this->serviceKramaMipil->getAllData($desadat_id, $request);
        ...
        return view('pages.desa.pelaporan.krama.laporan-krama-mipil', compact('data'));
    }
    ...
    public function lapKramaTamiu(Request $request)
    {
        ...
        return view('pages.desa.pelaporan.krama.laporan-krama-tamiu', compact('data'));
    }
    ...
    public function lapTamiu(Request $request)
    {
        ...
        return view('pages.desa.pelaporan.krama.laporan-tamiu', compact('data'));
    }
}
