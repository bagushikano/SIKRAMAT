...
class PerkawinanMasukDesaAdatController extends Controller
{
    ...
    public function index(){
        ...
        return view('pages.desa.perkawinan_masuk_desa_adat.perkawinan_masuk_desa_adat', compact('perkawinans'));
    }
    ...
    public function create(){
        ...
        return view('pages.desa.perkawinan_masuk_desa_adat.create', compact('banjar_adat', 'kabupatens'));
    }
    ...
    public function store(Request $request){
        ...
        return redirect()->route('desa-perkawinan-masuk-desa-adat-home')->with('success', 'Perkawinan berhasil ditambahkan');
    }
}
